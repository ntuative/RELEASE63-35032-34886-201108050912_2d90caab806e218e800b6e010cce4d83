package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2084:uint = 1;
      
      protected static const const_2083:uint = 2;
      
      protected static const const_2085:uint = 4;
      
      protected static const const_2086:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_2064:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1290:Boolean = false;
      ...
      protected var var_753:Class;
      
      protected var var_525:uint = 0;
      
      protected var _name:String;
      
      protected var var_1167:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1168:Boolean = false;
      
      protected var var_3090:String = "";
      ...
      protected var var_3153:uint = 0;
      
      protected var var_3092:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1290)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_929[_loc2_] as LibraryLoader;
            ...
            while(var_929.length < const_1828 && false)
            {
               _loc1_ = var_1136.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1167 ? uint(this.var_1444 - this.var_2298) : uint(getTimer() - this.var_2298);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_440,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_44.close();
            }
      ...
      {
         if(this.var_1168 && !_disposed)
         {
            this.var_1168 = false;
            if(!this.var_1167 && this.var_270)
            {
               this.var_1444 = -1;
      ...
      {
         if(!this.var_1167 && !_disposed && this.var_1445 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_270,const_2064 - this.var_1445);
            if(this.var_3092)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_440 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_440,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_440,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_440))
               {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_525 = LibraryLoader.name_5;
         ...
         if(this.var_525 == LibraryLoader.const_2086)
         {
         ...
         if(this.var_525 == LibraryLoader.name_5)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_440,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_753 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_753.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_440,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_440,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
