package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1841:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1935:String = "bool";
      ...
      private static const const_708:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_707:String = "value";
      
      private static const const_733:String = "true";
      
      private static const const_2113:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_708);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_708));
         }
         else
         {
            _loc4_ = param1.child(const_708)[0];
         }
         ...
         _loc7_ = param1.attribute(const_707);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_707));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_707)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_313 || _loc5_ == const_151)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1841:
               return Number(param1);
            case const_39:
               return param1 == const_733 || int(param1) > 0;
            case const_1935:
               return param1 == const_733 || int(param1) > 0;
            case const_161:
               return uint(param1);
            case const_151:
               return param1.split(const_1657);
            default:
