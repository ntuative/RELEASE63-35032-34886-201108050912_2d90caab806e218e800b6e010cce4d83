package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_957:Dictionary;
      ...
      {
         super(param1);
         this.var_958 = new Dictionary(false);
         this.var_957 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_304 = null;
            this.var_901 = null;
            for(_loc1_ in this.var_958)
            {
               _loc2_ = this.var_958[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_958[_loc1_];
            }
            this.var_958 = null;
            for(_loc1_ in this.var_957)
            {
               _loc2_ = this.var_957[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_957[_loc1_];
            }
            this.var_957 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_521[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_901.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_901.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_901.blueMultiplier = (param1.color & 255) / 255;
               this.var_901.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_901);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  else if(_loc10_.var_362 == SkinLayoutEntity.const_502)
                  {
                     _loc12_ = true;
                  ...
                  if(_loc10_.var_360 == SkinLayoutEntity.const_342)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_502)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_364)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_655)
                  {
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_364 || _loc10_.var_362 == SkinLayoutEntity.const_364)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_360 == SkinLayoutEntity.const_342)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_958[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_957[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
