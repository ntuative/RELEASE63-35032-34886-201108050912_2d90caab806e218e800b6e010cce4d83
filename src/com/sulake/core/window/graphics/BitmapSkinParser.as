package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_101:String = "com.sulake.habbo.ui.widget.roomqueue";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_362 = SkinLayoutEntity.const_622;
                  break;
               case "move":
                  _loc5_.var_362 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_362 = SkinLayoutEntity.const_502;
                  break;
               case "tiled":
            ...
            {
               case "fixed":
                  _loc5_.var_360 = SkinLayoutEntity.const_622;
                  break;
               case "move":
                  _loc5_.var_360 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_360 = SkinLayoutEntity.const_502;
                  break;
               case "tiled":
                  _loc5_.var_360 = SkinLayoutEntity.const_364;
                  break;
               case "center":
                  _loc5_.var_360 = SkinLayoutEntity.const_655;
            }
         }
