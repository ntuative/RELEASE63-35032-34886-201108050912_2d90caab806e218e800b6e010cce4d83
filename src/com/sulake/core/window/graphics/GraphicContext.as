package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2281:uint = 64;
      
      public static const const_2326:uint = 128;
      ...
      public function method_1() : Rectangle
      {
         ...
         if(this.var_956)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2295,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2295,16777215);
                  }
                  var_368 += bitmap.width * bitmap.height * 4;
               }
