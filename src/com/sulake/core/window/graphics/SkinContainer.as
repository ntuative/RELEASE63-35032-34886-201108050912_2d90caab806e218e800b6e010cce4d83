package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1114:uint = 8;
      
      private static const const_1667:String = "skin";
      
      private static const const_1663:String = "bitmap";
      
      private static const const_1666:String = "fill";
      
      private static const const_1665:String = "text";
      
      private static const const_1662:String = "label";
      
      private static const const_1664:String = "shape";
      ...
      private var var_2053:Dictionary;
      
      private var var_2802:Dictionary;
      
      private var var_2803:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2053 = new Dictionary();
         this.var_2802 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2053,this.var_2802);
         this.var_2803 = new Dictionary();
         this.var_2801 = new Dictionary();
         StateCodeTable.fillTables(this.var_2803,this.var_2801);
         this.var_483 = new Dictionary();
         this.var_483[const_1667] = BitmapSkinRenderer;
         this.var_483[const_1663] = BitmapDataRenderer;
         this.var_483[const_1666] = FillSkinRenderer;
         this.var_483[const_1665] = TextSkinRenderer;
         this.var_483[const_1662] = LabelRenderer;
         this.var_483[const_1664] = ShapeSkinRenderer;
         this.var_483[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_483[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_367 == null)
         {
            var_367 = new Array();
            var_367.push(WindowState.const_76);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3067 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2053[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1072[param1] = new Array(const_1114);
         }
         this.var_1072[param1][param2] = param3;
         if(this.var_1073[param1] == null)
         {
            this.var_1073[param1] = new Array(const_1114);
         }
         this.var_1073[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1072[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1073[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_103)
