package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1443:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_960:Number;
      
      protected var var_622:Number;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_506,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_506 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_506,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_767 ? true : null;
         }
      ...
      {
         this.var_960 = param1;
         this._field.scrollH = this.var_960 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_960 * this.maxScrollH,this.var_622 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_960 = this.var_960;
         _loc1_.var_622 = this.var_622;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_862,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1267));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1203 ? new PropertyStruct(PropertyDefaults.const_774,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1193) : PropertyDefaults.const_1778);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1350 ? new PropertyStruct(PropertyDefaults.const_1349,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1419) : PropertyDefaults.const_1802);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_1013) ? new PropertyStruct(PropertyDefaults.const_448,this._field.textColor,PropertyStruct.const_161,true) : PropertyDefaults.const_1374);
         ...
         _loc1_.push(this.var_43.left != PropertyDefaults.const_957 ? new PropertyStruct(PropertyDefaults.const_259,this.var_43.left,PropertyStruct.const_36,true) : PropertyDefaults.const_887);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_742 ? new PropertyStruct(PropertyDefaults.const_253,this.var_43.top,PropertyStruct.const_36,true) : PropertyDefaults.const_762);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_956 ? new PropertyStruct(PropertyDefaults.const_307,this.var_43.right,PropertyStruct.const_36,true) : PropertyDefaults.const_756);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_873 ? new PropertyStruct(PropertyDefaults.const_302,this.var_43.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_868);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1400 ? new PropertyStruct(PropertyDefaults.const_806,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1961);
