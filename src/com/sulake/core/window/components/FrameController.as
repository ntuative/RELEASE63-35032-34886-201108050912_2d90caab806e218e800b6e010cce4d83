package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1716:String = "_TITLE";
      
      private static const const_1719:String = "_HEADER";
      
      private static const const_1718:String = "_CONTENT";
      
      private static const const_1717:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1691:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1716) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1691 = findChildByTag(const_1719) as IHeaderWindow;
            if(!this.var_1691)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_199 = findChildByTag(const_1718) as IWindowContainer;
            if(!this.var_199)
            {
      ...
      {
         return findChildByTag(const_1717) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1436,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1167 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_312);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_266);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_312,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_312,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,_loc3_.top,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_307,0 - _loc3_.right,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_302,0 - _loc3_.bottom,PropertyStruct.const_36,_loc2_));
         return _loc1_;
      }
