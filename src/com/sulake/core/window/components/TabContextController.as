package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1758:String = "_SELECTOR";
      
      private static const const_1759:String = "_CONTENT";
       
      
      protected var var_1172:ITabSelectorWindow;
      
      protected var var_2300:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1172 = findChildByTag(const_1758) as ITabSelectorWindow;
            if(this.var_1172 != null)
            {
               this.var_1172.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2300 == null)
         {
            this.var_2300 = findChildByTag(const_1759) as IWindowContainer;
         }
      ...
      {
         return !!this.var_857 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1172.numSelectables;
      }
