package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1389:IItemListWindow;
      
      private var var_494:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_494)
         {
            this.var_494.removeEventListener(WindowEvent.const_207,this.scrollBarEventProc);
            this.var_494.removeEventListener(WindowEvent.const_234,this.scrollBarEventProc);
            this.var_494 = null;
         }
         if(this.var_1389)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1389)
         {
            this.var_1389 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_494)
         {
            this.var_494 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_494)
            {
               this.var_494.addEventListener(WindowEvent.const_207,this.scrollBarEventProc);
               this.var_494.addEventListener(WindowEvent.const_234,this.scrollBarEventProc);
            }
         }
         return this.var_494;
      }
