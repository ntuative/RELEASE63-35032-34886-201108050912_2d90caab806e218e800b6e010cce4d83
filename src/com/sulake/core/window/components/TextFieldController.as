package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1723:uint = 500;
      
      protected var var_1430:String = "";
      
      protected var var_1442:Boolean = false;
      
      protected var var_857:Boolean = false;
      ...
      {
         this.var_1430 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_857 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_384,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_1001,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1931);
         _loc1_.push(this.var_1442 != PropertyDefaults.const_1244 ? new PropertyStruct(PropertyDefaults.const_935,this.var_1442,PropertyStruct.const_39,true) : PropertyDefaults.const_2026);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1284 ? new PropertyStruct(PropertyDefaults.const_838,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_2054);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1231 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1914);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_935:
                  this.var_1442 = _loc2_.value as Boolean;
                  if(this.var_1442)
                  {
               ...
               case PropertyDefaults.const_1001:
                  ...
                  break;
               case PropertyDefaults.const_1333:
