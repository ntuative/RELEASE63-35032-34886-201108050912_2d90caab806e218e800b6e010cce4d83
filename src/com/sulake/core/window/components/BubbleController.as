package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2127:String = "_POINTER_UP";
      
      private static const const_2124:String = "_POINTER_DOWN";
      
      private static const const_2126:String = "_POINTER_LEFT";
      
      private static const const_2125:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_904;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1024,this._direction,PropertyStruct.const_52,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1986);
         }
         if(this.var_904 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_818,this.var_904,PropertyStruct.const_36,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_1024:
