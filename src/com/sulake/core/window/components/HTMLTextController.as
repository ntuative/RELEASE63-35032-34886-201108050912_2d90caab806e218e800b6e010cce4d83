package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_990:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_811:String;
      
      private var var_1205:String = null;
      ...
      {
         this.var_811 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1205 == param2)
         {
            return;
         }
         param1.var_1205 = param2;
         param1.var_1802 = null;
         if(param1.var_1205 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1205);
      ...
      {
         if(PropertyDefaults.const_912.indexOf(param1) > -1)
         {
            this.var_811 = param1;
         }
      }
      ...
      {
         return this.var_811 == LinkTarget.const_29 ? defaultLinkTarget : this.var_811;
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1415)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_811 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1019,this.var_811,PropertyStruct.const_52,true,PropertyDefaults.const_912));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_1019)
            {
               this.var_811 = _loc2_.value as String;
               break;
            }
