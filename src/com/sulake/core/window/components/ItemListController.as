package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2284:Boolean = false;
      ...
      protected var var_766:Number = -1.0;
      
      protected var var_767:Number = -1.0;
      
      protected var var_1163:Boolean = true;
      
      protected var var_523:Boolean = false;
      
      protected var var_1435:Boolean = false;
      
      protected var var_2285:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_191 = var_516 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_400,WindowStyle.const_103,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_407,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_768 * this.maxScrollH,this.var_765 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_768 = param1;
            this._container.x = -this.var_768 * this.maxScrollH;
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_765 = param1;
            this._container.y = -this.var_765 * this.maxScrollV;
            if(_events)
            {
               _loc2_ = WindowEvent.allocate(WindowEvent.const_526,this,null);
               _events.dispatchEvent(_loc2_);
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_407,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_197:
               if(this.var_1436)
               {
                  this.var_1434 = this.var_2285 - _loc3_;
                  this.var_1433 = this.var_2286 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1434 != 0 && this.var_124 != 0)
                     {
                        this.scrollH += this.var_1434 / this.var_124;
                     }
                  }
                  else if(this.var_1433 != 0 && this.var_107 != 0)
                  {
                     this.scrollV += this.var_1433 / this.var_107;
                  }
                  this.var_2285 = _loc3_;
                  this.var_2286 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_267:
               if(this.var_1436)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1434,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1433);
                  }
                  this.var_1436 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1163 && !this.var_618 && this._container)
         {
            this.var_618 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_885)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_434,this._spacing,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1230);
         }
         if(this.var_1163 != PropertyDefaults.const_1293)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_960,this.var_1163,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1944);
         }
         if(this.var_523 != PropertyDefaults.const_1384)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_761,this.var_523,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2060);
         }
         if(this.var_1435 != PropertyDefaults.const_1307)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_941,this.var_1435,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2008);
         }
         if(this.var_766 != PropertyDefaults.const_1345)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1016,this.var_766,PropertyStruct.const_140,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1954);
         }
         if(this.var_767 != PropertyDefaults.const_1328)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_899,this.var_767,PropertyStruct.const_140,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2058);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_761:
                  ...
                  break;
               case PropertyDefaults.const_941:
                  this.resizeOnItemUpdate = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_960:
                  this.var_1163 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_1016:
                  this.var_766 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_899:
                  this.var_767 = _loc2_.value as Number;
                  break;
            }
         }
