package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1619:String = "increment";
      
      private static const const_1618:String = "decrement";
      
      private static const const_1104:String = "slider_track";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_191 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_519;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_526,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_526,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1047 = _loc3_.value as String;
               this.var_18 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1104) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         if(param2.type == WindowEvent.const_657)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_368)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_769;
                  }
                  else
                  {
                     this.scrollV -= this.var_769;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_801)
         {
            ...
            else if(param2.name == const_1618)
            {
               if(this.var_18)
               {
                  this.var_1298 = true;
         ...
         if(param1.type == WindowMouseEvent.const_368)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1047) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1047) as IScrollableWindow;
               if(_loc1_)
               {
