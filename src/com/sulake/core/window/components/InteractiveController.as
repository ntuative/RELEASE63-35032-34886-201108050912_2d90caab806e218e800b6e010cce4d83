package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_496)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_785,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1962);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1190)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_829,param1.toolTipDelay,PropertyStruct.const_254,true));
         }
         else
         {
      ...
      {
         this.var_1430 = param1 == null ? "null" : param1;
      }
