package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1585:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1586:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_180:IProfiler;
      
      private var var_25:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_3108:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3108 = new Array();
         this.var_180 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1585() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_180)
         {
            this.var_180.removeStopEventListener(this.refresh);
            this.var_180 = null;
         }
         if(!this.var_180 && param1)
         {
            this.var_180 = param1;
            this.var_180.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_635)
            {
               this.var_1999 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_180.getProfilerAgentsInArray();
         ...
         if(this.var_1999)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_180.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_180.numBitmapAssetInstances + " / " + this.var_180.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_180.numTrackedBitmapDataInstances + " / " + this.var_180.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1586() as ByteArray;
