package com.sulake.core.window.utils
{
   ...
   public class TextFieldCache implements IDisposable
   {
      ...
      private static var var_1049:Map = new Map();
      ...
      {
         var _loc2_:TextField = var_1049[param1.name];
         if(_loc2_)
         {
            return _loc2_;
         }
         ...
         _loc3_.underline = param1.textDecoration == TextStyle.const_767 ? true : null;
