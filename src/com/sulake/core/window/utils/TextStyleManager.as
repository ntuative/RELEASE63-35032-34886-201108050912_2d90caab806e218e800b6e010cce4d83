package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_607:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_726:String = "{";
      
      private static const const_725:String = "}";
      
      private static const const_1724:String = "/*";
      
      private static const const_1725:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_100[const_226],var_100[ITALIC],var_100[BOLD]];
            var_100.reset();
            var_100[const_226] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_607.indexOf(_loc4_.name) == -1)
            {
               var_607.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_725);
         if(countSubStrings(param1,const_726) != countSubStrings(param1,const_725))
         {
            throw new Error("Mismatching amount of \"" + const_726 + "\" versus \"" + const_725 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1724) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1725) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_726)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
