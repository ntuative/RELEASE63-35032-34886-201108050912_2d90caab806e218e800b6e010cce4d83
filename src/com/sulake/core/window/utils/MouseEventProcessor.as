package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_145:WindowController;
      
      protected var var_71:WindowController;
      
      protected var var_184:IWindowRenderer;
      
      protected var var_95:IDesktopWindow;
      
      protected var var_952:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_366 = new Array();
            var_366[0] = MouseCursorType.const_330;
            var_366[1] = MouseCursorType.const_29;
            var_366[2] = MouseCursorType.const_330;
            var_366[3] = MouseCursorType.const_330;
            var_366[4] = MouseCursorType.const_330;
            var_366[5] = MouseCursorType.const_29;
            var_366[6] = MouseCursorType.const_330;
         }
         if(var_319 == null)
         {
            var_319 = new Array();
            var_319[0] = WindowState.const_91;
            var_319[1] = WindowState.const_88;
            var_319[2] = WindowState.const_94;
            var_319[3] = WindowState.const_76;
            var_319[4] = WindowState.const_55;
            var_319[5] = WindowState.const_96;
            var_319[6] = WindowState.const_86;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_267;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1426 as WindowController;
         this.var_145 = state.var_1427 as WindowController;
         this.var_184 = state.renderer;
         this.var_952 = state.var_1428;
         eventQueue.begin();
         this.var_762.x = -1;
         this.var_762.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_762.x || event.stageY != this.var_762.y)
            {
               ...
               array = new Array();
               this.var_95.groupParameterFilteredChildrenUnderPoint(this.var_762,array,WindowParam.const_30);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK || event.type == MouseEvent.MOUSE_DOWN)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_952.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1426 = this.var_71;
         state.var_1427 = this.var_145;
         state.renderer = this.var_184;
         state.var_1428 = this.var_952;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               if(this.var_145 && !this.var_145.disposed)
               {
                  this.var_145.update(this.var_145,convertMouseEventType(new MouseEvent(MouseEvent.MOUSE_UP,false,true,param2.localX,param2.localY,null,param2.ctrlKey,param2.altKey,param2.shiftKey,param2.buttonDown,param2.delta),this.var_145,param1));
                  this.var_145 = null;
                  if(param1.disposed)
                  {
                     return null;
         ...
         if(!_loc4_)
         {
            _loc9_ = this.var_184.getDrawBufferForRenderable(param1);
