package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1407:String = "_EXCLUDE";
      
      public static const const_2273:String = "_INCLUDE";
      
      public static const const_2174:String = "_TEMP";
      
      private static const const_1747:String = "layout";
      
      private static const name_6:String = "window";
      
      private static const const_1161:String = "variables";
      
      private static const const_1160:String = "filters";
      
      private static const const_732:String = "name";
      
      private static const const_1743:String = "style";
      
      private static const const_734:String = "params";
      
      private static const const_1741:String = "tags";
      ...
      private static const const_1748:String = "visible";
      
      private static const const_1746:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1430:String = "blend";
      
      private static const const_1750:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1742:String = "treshold";
      
      private static const const_1751:String = "children";
      
      private static const const_1163:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1162:String = "height_min";
      
      private static const const_1164:String = "height_max";
      
      private static const const_733:String = "true";
      
      private static const const_183:String = "0";
      
      private static const const_1744:String = "$";
      
      private static const const_1657:String = ",";
      
      private static const const_51:String = "";
      
      private static const const_1749:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1745:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1447:Dictionary;
      
      protected var var_1446:Dictionary;
      
      protected var var_1170:Dictionary;
      
      protected var var_1734:Dictionary;
      
      protected var var_2299:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1446 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1447,this.var_1446);
         this.var_1170 = new Dictionary();
         this.var_1734 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1170,this.var_1734);
         this.var_2299 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1745,const_51);
         return param1.replace(const_1749,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1446)
            {
               delete this.var_1446[_loc1_];
            }
            for(_loc1_ in this.var_1170)
            {
               delete this.var_1170[_loc1_];
            }
            for(_loc1_ in this.var_1734)
            {
               delete this.var_1734[_loc1_];
            }
            this.var_2299.dispose();
            this.var_2299 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1747)
         {
            _loc8_ = param1.child(const_1161);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1160).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1447[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_732,variables,"")));
         style = uint(this.parseAttribute(xml,const_1743,variables,style));
         params = uint(this.parseAttribute(xml,const_734,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1741,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1748,variables,visible.toString()) == const_733;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_734).length() > 0)
         {
            list = xml.child(const_734).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_732,variables,"") as String;
               if(this.var_1170[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_732)) + "\"!");
               }
               params |= this.var_1170[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1746,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1657);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1161)[0]),tags) as WindowController;
         if(this.hasAttribute(xml,const_1163))
         {
            window.limits.minWidth = int(this.parseAttribute(xml,const_1163,variables,window.limits.minWidth));
         }
         ...
         if(this.hasAttribute(xml,const_1162))
         {
            window.limits.minHeight = int(this.parseAttribute(xml,const_1162,variables,window.limits.minHeight));
         }
         if(this.hasAttribute(xml,const_1164))
         {
            window.limits.maxHeight = int(this.parseAttribute(xml,const_1164,variables,window.limits.maxHeight));
         }
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_733;
         blend = Number(this.parseAttribute(xml,const_1430,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1750,variables,window.clipping.toString()) == const_733;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1742,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1160).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1446[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1407) == -1)
                  {
