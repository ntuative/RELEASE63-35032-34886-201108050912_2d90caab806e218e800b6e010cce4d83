package com.sulake.core.window.services
{
   ...
   public class FocusManager extends ChildEntityArrayReader implements IFocusManagerService
   {
      ...
      private var var_156:Stage;
      
      public function FocusManager(param1:DisplayObject)
      {
         this.var_156 = param1.stage;
         this.var_156.addEventListener(Event.ACTIVATE,this.onActivateEvent);
         this.var_156.addEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
         this.var_156.addEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
         this.var_156.addEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
         super();
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this.var_156.removeEventListener(Event.ACTIVATE,this.onActivateEvent);
            this.var_156.removeEventListener(FocusEvent.FOCUS_OUT,this.onFocusEvent);
            this.var_156.removeEventListener(FocusEvent.KEY_FOCUS_CHANGE,this.onFocusEvent);
            this.var_156.removeEventListener(FocusEvent.MOUSE_FOCUS_CHANGE,this.onFocusEvent);
            this.var_156 = null;
            this._disposed = true;
            var_34 = null;
         }
