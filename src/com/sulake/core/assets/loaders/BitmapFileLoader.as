package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1160 = new LoaderContext();
         this.var_1160.checkPolicyFile = true;
         ...
         {
            this.var_44.load(param2,this.var_1160);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_365 = 0;
         this.var_44.load(param1,this.var_1160);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_365 < var_3089)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1161 + (this.var_1161.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_365),this.var_1160);
               return true;
            }
         }
         return false;
