package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2161:uint = 1;
      ...
      private var var_606:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_606 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_606.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_606.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1443 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1443);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1526 & const_1377)
         {
            if(_loc3_ == 0)
            {
               if(this.var_606.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_789 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_606.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_606.getStructByIndex(_loc8_);
