package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_184:IRoomRendererBase;
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_184 != null)
            {
               this.var_184.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_184)
               {
                  this.var_184.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_184)
                  {
                     this.var_184.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_184.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
