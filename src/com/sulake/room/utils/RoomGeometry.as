package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_665:Number = 64;
      
      public static const const_1297:Number = 32;
      ...
      private var var_1890:Number = 1.0;
      ...
      private var var_3101:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1254 = new Vector3d();
         this.var_1892 = 1;
         this.var_1890 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1891 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_463.assign(this.var_104);
         this.var_463.x *= this.var_462;
         this.var_463.y *= this.var_464;
         this.var_463.z *= this.var_465;
         return this.var_463;
      }
      ...
      {
         if(this.var_462 != param1 * this.var_1892)
         {
            this.var_462 = param1 * this.var_1892;
            ++this.var_177;
         }
      }
      ...
      {
         if(this.var_464 != param1 * this.var_1890)
         {
            this.var_464 = param1 * this.var_1890;
            ++this.var_177;
         }
      }
      ...
      {
         if(this.var_465 != param1 * this.var_1891)
         {
            this.var_465 = param1 * this.var_1891;
            ++this.var_177;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_104.x /= this.var_462;
         this.var_104.y /= this.var_464;
         this.var_104.z /= this.var_465;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1255.assign(this.var_173);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1254.assign(_loc22_);
         }
         else
         {
            this.var_1254.assign(_loc17_);
         }
         ++this.var_177;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_464;
         _loc2_.z *= this.var_465;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1254);
         if(_loc3_ < this.var_3101 || _loc3_ > this.var_3102)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_464;
            _loc2_.z *= this.var_465;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1254);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_104.x * this.var_462,this.var_104.y * this.var_464,this.var_104.z * this.var_465);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_173;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_462,param2.y * this.var_464,param2.z * this.var_465);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_462,param3.y * this.var_464,param3.z * this.var_465);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_462,param4.y * this.var_464,param4.z * this.var_465);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1297;
         }
         else
         {
            this.scale = const_665;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_665;
      }
