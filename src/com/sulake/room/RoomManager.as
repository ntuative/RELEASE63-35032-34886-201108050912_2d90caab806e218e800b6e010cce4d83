package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_178:IRoomManagerListener;
      
      private var var_3141:IRoomContentLoader;
      
      private var var_691:IRoomObjectFactory = null;
      
      private var var_568:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1293:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_794,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_691 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_691 == null || this.var_568 == null)
         {
            return;
         }
         this._state = const_1903;
         if(this.var_1293 != null)
         {
            _loc1_ = this.var_1293;
            this.var_1293 = null;
            this.initialize(_loc1_,this.var_178);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_690.indexOf(_loc5_) < 0)
            {
               this.var_58.loadObjectContent(_loc5_,events);
               this.var_690.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_568.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_568.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_691.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_691 != null)
         {
            return this.var_691.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_58.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_690.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_690.splice(_loc2_,1);
            }
            if(this.var_690.length == 0)
            {
               this._state = const_903;
               if(this.var_178 != null)
               {
                  this.var_178.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_950;
            this.var_178.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_178 != null)
            {
               this.var_178.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1040.indexOf(_loc2_) < 0)
         {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1040.length > 0)
         {
            _loc2_ = this.var_1040[0];
            this.var_1040.splice(0,1);
            _loc3_ = this.var_58.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_178 != null)
               {
                  this.var_178.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_178 != null)
            {
               this.var_178.contentLoaded(_loc2_,true);
            }
            if(this.var_690.length > 0)
            {
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2679)
            {
               this.var_1973 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_568 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_568.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_568.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_691.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_178 != null)
                              {
                                 this.var_178.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
