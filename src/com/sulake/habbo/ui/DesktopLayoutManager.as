package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_716:String = "room_view";
      
      private static const const_1692:String = "room_widget";
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_366)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1692) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_99.getChildByTag(const_716) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get method_2() : Rectangle
      {
         if(this.var_99 == null)
         {
            return null;
         }
         var _loc1_:IWindowContainer = this.var_99.findChildByTag(const_716) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
