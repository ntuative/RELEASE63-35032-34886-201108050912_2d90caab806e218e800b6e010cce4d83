package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_982:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_119:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_119)
         {
            return;
         }
         this._state = const_1835;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_738,this._id));
      }
