package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_113,this.method_5);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_350,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_113,this.method_5);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_350,this.onHideLoadingBar);
      }
      ...
      private function method_5(param1:RoomWidgetLoadingBarUpdateEvent) : void
      {
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_350)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1423 != "")
         {
            HabboWebTools.openWebPage(this.var_1423);
         }
      }
   }
}
