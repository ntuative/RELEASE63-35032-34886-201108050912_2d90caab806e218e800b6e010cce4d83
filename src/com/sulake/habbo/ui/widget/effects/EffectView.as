package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2405:int = 1000;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_117 = param2;
         this._widget = param1;
         this.var_230 = new Timer(this.const_2405);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_117.isActive)
         {
            ...
            this.var_749.width = _loc2_ * this.var_355;
         }
         else
         {
            this.var_749.width = 0;
            this.var_230.stop();
         }
         this.setTimeLeft();
      }
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_72,HabboWindowStyle.const_29,HabboWindowParam.const_65) as IWindowContainer;
         }
         ...
         else
         {
            ...
            this.var_748 = this._window.findChildByName("effect_hilite");
            this.var_748.visible = false;
         }
         this.setTimeLeft();
         this.var_749 = this._window.findChildByName("loader_bar");
         if(this.var_749 != null)
         {
            this.var_355 = this.var_749.width;
            this.var_230.start();
            this.onUpdate();
         }
