package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3122:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3122 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_398:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_76,this.var_150,this.var_2982++,this);
               break;
            case RoomWidgetEnum.const_366:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_76,this.var_150,this);
               break;
            case RoomWidgetEnum.const_668:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_76,this.var_150,this._catalog);
               break;
            case RoomWidgetEnum.const_631:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_76,events,this.var_150);
               break;
            ...
            case RoomWidgetEnum.const_512:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_76,this.var_150,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_585:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_76,this.var_150);
               break;
            case RoomWidgetEnum.const_533:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_76,this.var_150);
               break;
            case RoomWidgetEnum.const_139:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_76,this.var_150);
               break;
            ...
            case RoomWidgetEnum.const_137:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_150,this.var_76,this);
               break;
            ...
            case RoomWidgetEnum.const_503:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_76,this.var_150,this._catalog);
               break;
