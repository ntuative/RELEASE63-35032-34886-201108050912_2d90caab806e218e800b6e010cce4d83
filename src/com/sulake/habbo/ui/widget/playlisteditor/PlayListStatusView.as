package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1346:String = "PLSV_START_PLAYBACK";
      
      public static const const_548:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_548)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_445[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_445[const_875];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_445.add(const_548,_loc1_);
