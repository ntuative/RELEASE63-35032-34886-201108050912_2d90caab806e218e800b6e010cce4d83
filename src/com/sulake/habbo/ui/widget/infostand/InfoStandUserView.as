package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1122:TagListRenderer;
      ...
      private const const_704:int = 5;
      
      private const const_2109:int = 3;
      
      private const const_1625:int = 11184810;
      
      private const const_1626:int = 16777215;
      
      private const const_2388:int = 2000;
      
      private const const_2110:int = 50;
      
      private const const_2108:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1122 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2724 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_704;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1625;
            }
            else
            {
               _loc5_.textColor = this.const_1626;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_704,this.const_2110);
         _loc5_.height = Math.max(_loc5_.height,this.const_2108);
         _loc3_.height = _loc5_.height + this.const_2109;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_384,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_384,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1122.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_736:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_946:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2725 > this.const_2388 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2725 = _loc6_;
               _loc3_.textColor = this.const_1626;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1625;
         }
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_704,this.const_2110);
         _loc3_.height = Math.max(_loc3_.height,this.const_2108);
         _loc2_.height = _loc3_.height + this.const_2109;
      }
