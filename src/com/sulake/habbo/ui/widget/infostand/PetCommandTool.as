package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_505:IFrameWindow;
      ...
      private const const_2404:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_423 = new Timer(this.const_2404);
         this.var_423.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1414.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_610);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1414.getValue(this.var_610) as CommandConfiguration;
      ...
      {
         this.var_1414.remove(param1);
         this.var_1414.add(param1,param2);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.setParamFlag(WindowParam.const_106,true);
         ...
         this.var_42.position = const_1576;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_505 == null)
         {
            ...
            this.var_505 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_505 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_505.x = 200;
            this.var_505.procedure = this.onInfoWindowProcedure;
         }
         else
         {
            this.var_505.visible = true;
         }
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_280,this.var_610));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_637,this.var_610,this.var_2196 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_637,this.var_610,this.var_2196 + " " + _loc5_);
