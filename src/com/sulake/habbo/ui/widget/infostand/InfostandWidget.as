package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2134:String = "infostand_user_view";
      
      private const const_2137:String = "infostand_furni_view";
      
      private const const_2136:String = "infostand_pet_view";
      
      private const const_2135:String = "infostand_bot_view";
      
      private const const_2138:String = "infostand_jukebox_view";
      
      private const const_2133:String = "infostand_songdisk_view";
      
      private var var_1420:InfoStandFurniView;
      
      private var var_208:InfoStandUserView;
      
      private var var_428:InfoStandPetView;
      
      private var var_510:InfoStandBotView;
      
      private var var_1150:InfoStandJukeboxView;
      
      private var var_1149:InfoStandSongDiskView;
      
      private var var_3048:Array;
      ...
      private const const_2406:int = 3000;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1420 = new InfoStandFurniView(this,this.const_2137,this._catalog);
         this.var_208 = new InfoStandUserView(this,this.const_2134);
         this.var_428 = new InfoStandPetView(this,this.const_2136,this._catalog);
         this.var_510 = new InfoStandBotView(this,this.const_2135);
         this.var_1150 = new InfoStandJukeboxView(this,this.const_2138,this._catalog);
         this.var_1149 = new InfoStandSongDiskView(this,this.const_2133,this._catalog);
         this.var_1716 = new InfostandUserData();
         this.var_639 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_187 = new Timer(this.const_2406);
         this.var_187.addEventListener(TimerEvent.TIMER,this.onUpdateTimer);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_201,this.onRoomObjectRemoved);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_201,this.onRoomObjectRemoved);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_280,this.var_428.getCurrentPetId()));
      }
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_428.update(this.petData);
      ...
      {
         this.var_428.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_208.setTags(param1.tags,this.var_3048);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_603,param1.id,param1.category);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_201:
               ...
               if(this.var_428 != null && this.var_428.window != null && this.var_428.window.visible)
               {
      ...
      {
         this.var_1150.updateSongInfo(param1);
         this.var_1149.updateSongInfo(param1);
      }
