package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2403:int = 5;
      
      private const const_2402:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_178:Function;
      
      private var _offsetX:int;
      
      private var var_1383:int;
      
      private var var_1382:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1383 = 0;
         this.var_1382 = param2.rectangle.clone();
         this.var_1382.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1382.width)
         {
            return false;
         }
         if(this.var_1383 + param1.height > this.var_1382.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1382.width)
         {
            this._offsetX = 0;
            this.var_1383 += param1.height + this.const_2402;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1383);
         this._offsetX += param1.width + this.const_2403;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1668 != null && this.var_1668.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_178);
