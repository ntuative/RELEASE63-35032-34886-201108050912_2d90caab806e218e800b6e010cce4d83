package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "HabboModerationCom_chatlog_chatline_xml":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1335 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_649 && param1.isRoomOwner)
         {
         ...
         this.showButton("HabboModerationCom_chatlog_chatline_xml",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1370.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
