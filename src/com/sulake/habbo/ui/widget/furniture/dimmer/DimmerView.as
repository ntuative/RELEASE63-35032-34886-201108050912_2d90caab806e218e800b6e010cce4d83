package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1509:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_647:DimmerViewColorGrid;
      
      private var var_457:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_72,HabboWindowStyle.const_29,0 | 0,new Rectangle(const_1524,const_1525,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_647 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_457 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1510 = _loc2_.light;
         if(this.var_457 != null)
         {
            this.var_457.setValue(this.var_1510);
         }
         this.var_613 = this.colors.indexOf(_loc2_.color);
         if(this.var_647 != null)
         {
            this.var_647.setSelectedColorIndex(this.var_613);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1509 = XML(_loc1_.content);
         return this.var_1509;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_457 != null)
         {
            this.var_457.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_647 != null)
         {
            this.var_647.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
