package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_998 = param1.volume;
         if(this.var_999 != null)
         {
            this.var_999.setValue(this.var_998);
         }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_998 == 0)
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1001);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1002);
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_904);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_999);
         }
