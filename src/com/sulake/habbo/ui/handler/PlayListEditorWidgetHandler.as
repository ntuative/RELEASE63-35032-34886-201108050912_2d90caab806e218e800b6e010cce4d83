package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1714:IMessageEvent;
      
      private var var_2209:IMessageEvent;
      
      private var var_2208:IMessageEvent;
      ...
      {
         this.var_1714 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2209 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2208 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1714);
         this._connection.addMessageEvent(this.var_2209);
         this._connection.addMessageEvent(this.var_2208);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1714);
               this._connection.removeMessageEvent(this.var_2209);
               this._connection.removeMessageEvent(this.var_2208);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_922,RoomWidgetPlayListModificationMessage.const_962,RoomWidgetPlayListModificationMessage.const_758,RoomWidgetPlayListPlayStateMessage.const_867,RoomWidgetPlayListUserActionMessage.const_1002];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetPlayListModificationMessage.const_962:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_758:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_867:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_1002:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_275);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_275:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_986,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_920,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_970));
               break;
