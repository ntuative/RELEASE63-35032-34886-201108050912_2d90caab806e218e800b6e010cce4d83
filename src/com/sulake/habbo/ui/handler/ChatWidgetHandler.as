package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1241:Number = 0.0;
      
      private var var_831:Point = null;
      
      private var var_547:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1242 = [];
         this.var_547 = new Vector3d();
         super();
         this.var_461 = new Map();
         this.var_330 = new Map();
         this.var_652 = new Map();
         this.var_1867 = new Map();
      }
      ...
      {
         return [RoomWidgetChatMessage.const_1012,RoomWidgetChatSelectAvatarMessage.const_926];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_1012:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_33) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1396))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_439);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_33) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1396))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_561);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_926:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1241 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1241);
            }
            if(this.var_831 == null)
            {
               ...
               this.var_547.y = 0;
               this.var_547.z = 0;
               this.var_831 = _loc4_.getScreenPoint(this.var_547);
               this.var_1241 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_547.x = 0;
            this.var_547.y = 0;
            this.var_547.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_547);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_831.x || _loc8_.y != this.var_831.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_831,_loc5_));
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1867.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1867.remove(param1);
         if(_loc3_ != null)
         {
