package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_818 = [];
         this.var_818.push(new WelcomeGiftStatusEvent(this.method_10));
         this.var_818.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_818)
         {
            return;
         }
         for each(_loc1_ in this.var_818)
      ...
      private function method_10(param1:WelcomeGiftStatusEvent) : void
      {
