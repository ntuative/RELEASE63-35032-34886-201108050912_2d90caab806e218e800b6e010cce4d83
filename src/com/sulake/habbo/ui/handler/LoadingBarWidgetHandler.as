package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(InterstitialEvent.const_508);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_113);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_350);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_550:
               ...
               break;
            case InterstitialEvent.const_508:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_113:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_350:
               this._container.events.dispatchEvent(param1);
         }
      }
