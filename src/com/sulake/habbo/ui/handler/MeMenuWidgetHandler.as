package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this.var_12 && !this.var_12.disposed && this.var_12.events)
            {
               ...
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_219,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_952,this.onHelpTutorialEvent);
            ...
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_141,this.onCreditBalance);
            }
         }
         ...
         if(this.var_12 != null)
         {
            ...
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_219,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_952,this.onHelpTutorialEvent);
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_141,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1507)
            {
               ...
               this.var_1812 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1813;
               _loc2_ = this.var_1812;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_476)
               {
                  ...
                  if(_loc2_.height > const_476 - const_1070)
                  {
                     _loc8_.offset(0,_loc2_.height - const_476 + const_1070);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_996);
         _loc1_.push(RoomWidgetDanceMessage.const_998);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_889);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1243);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1259);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1348);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_1023);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_1033);
         _loc1_.push(RoomWidgetStopEffectMessage.const_828);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_2027);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1247);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_630);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1932);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1405);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_825);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_847);
         _loc1_.push(RoomWidgetMeMenuMessage.const_880);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_905);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1865);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_904);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_999);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1253);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_456);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_847:
               ...
               break;
            case RoomWidgetWaveMessage.const_996:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_998:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1243:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1259:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_1033:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_1023:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1836:
                        this._catalog.openCatalogPage(CatalogPageName.const_1322,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1329:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_250);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1919:
                        this.var_12.toggleInventoryPage(InventoryCategory.const_70);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1907:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1348:
            case RoomWidgetStopEffectMessage.const_828:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1247:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_825:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_880:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_141,this._catalog.getPurse().credits));
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_630:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_567));
                  }
               }
               break;
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_141,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_133:
               ...
               break;
            case HabboHelpTutorialEvent.const_952:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_559));
         }
      }
