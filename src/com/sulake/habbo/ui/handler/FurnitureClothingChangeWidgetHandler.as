package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1550:String = "hd-99999-99999.lg-270-62";
      
      private static const const_1549:String = "hd-99999-99999.ch-630-62.lg-695-62";
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_431);
         }
         this.var_1164 = true;
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_805,RoomWidgetClothingChangeMessage.const_971,RoomWidgetAvatarEditorMessage.const_630];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_805:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_971:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc8_ = "null";
                     _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1383);
                     ...
                     {
                        _loc8_ = "null";
                        _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1352);
                        if(_loc9_ == null || _loc9_ == "")
                        {
                           _loc9_ = const_1549;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_431,this,[AvatarEditorFigureCategory.const_260,AvatarEditorFigureCategory.const_830],false,"${widget.furni.clothingchange.editor.title}"))
                     {
                        this._container.avatarEditor.loadAvatarInEditor(AvatarEditorInstanceId.const_431,_loc9_,_loc8_,HabboClubLevelEnum.const_53);
