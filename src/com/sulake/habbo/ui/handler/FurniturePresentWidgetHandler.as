package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_988,RoomWidgetPresentOpenMessage.const_196];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_988:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_264);
      ...
      {
         return [RoomSessionPresentEvent.const_376];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_376:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_63:
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_240)
                           {
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1637)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_338:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_605,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
