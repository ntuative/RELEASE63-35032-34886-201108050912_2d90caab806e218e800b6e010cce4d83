package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_770);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_866);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_746);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_770:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_866:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_746:
