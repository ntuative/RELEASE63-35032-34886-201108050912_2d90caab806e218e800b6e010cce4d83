package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_240.events.addEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_240 != null)
         {
            this.var_240.events.removeEventListener(NowPlayingEvent.const_102,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_603);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_984);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_1299);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_781);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_853);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_775);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1923);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_280);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_739);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_606)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_280 || param1.type == RoomWidgetUserActionMessage.const_523 || param1.type == RoomWidgetUserActionMessage.const_659)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_603:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_984:
            ...
            case RoomWidgetUserActionMessage.const_610:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1394,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_949:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1299:
               ...
               break;
            case RoomWidgetUserActionMessage.const_280:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_781:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_853:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_775:
            ...
            case RoomWidgetPetCommandMessage.const_637:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_739:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_264);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_443) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_443);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_787) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1335;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_264);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1289);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_128)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_591)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_162)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_844);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_736;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_946;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1968);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_844);
