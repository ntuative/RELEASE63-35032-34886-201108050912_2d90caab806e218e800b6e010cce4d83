package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2076:String = "ctlg_";
       
      
      protected var var_2280:XML;
      ...
      private var var_564:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1287:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_564 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1286);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1286);
      }
      ...
      {
         var _loc2_:String = const_2076 + param1;
         ...
         this.var_2280 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2280) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1980:
               if(this.var_1287 == null)
               {
                  this.var_1287 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1287);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1899:
               ...
               break;
            case CatalogWidgetEnum.const_2049:
            ...
            case CatalogWidgetEnum.const_1862:
               ...
               break;
            case CatalogWidgetEnum.const_1930:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_564.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_564 != null)
         {
            return this.var_564.dispatchEvent(param1);
         }
         return false;
      }
