package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_469:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_469 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_469)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_469.numSelectables)
            {
               _loc4_ = this.var_469.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_118[this.var_573]);
      ...
      {
         var _loc2_:int = this.var_747[this.var_573];
         var _loc3_:Offer = this.var_227[this.var_573][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_524.numGridItems)
         {
            _loc2_ = this.var_227[this.var_573][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_747[this.var_573] = (this.var_227[this.var_573] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_747[0];
         var _loc2_:int = this.var_747[1];
         var _loc3_:int = this.var_747[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_397 || _loc1_.pricingModel == Offer.const_458))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_71))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_469.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_469.setSelected(this.var_469.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_524)
            {
               var_524.destroyGridItems();
            }
            page.replaceOffers(this.var_227[this.var_573],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_747[this.var_573];
