package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2390:int = 40;
      
      private const const_2389:int = 10;
      
      private var var_871:Array;
      
      private var var_1600:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_576)
         {
            this.var_576.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_576 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_871 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_871 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_871));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_576)
         {
            this.var_576 = new Timer(25);
            this.var_576.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1320 = 0;
         this.populateList();
         this.var_576.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1320 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1320));
            ++this.var_1320;
            _loc1_++;
         }
         return false;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_871.length)
         {
            _loc4_ = this.var_871[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_110)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2389;
                  break;
               case "search_input":
                  _loc8_ = this.const_2390;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1600.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_47)
