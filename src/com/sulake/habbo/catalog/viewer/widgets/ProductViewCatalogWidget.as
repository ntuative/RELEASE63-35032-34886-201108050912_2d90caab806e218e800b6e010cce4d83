package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1003 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1216 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_194 != null)
         {
            ...
            this.var_538 = this.var_194.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_538 != null && _loc3_ != null)
            {
               this.var_194.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_538.width,this.var_538.height);
               if(_loc4_ != null)
               {
                  this.var_538.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1817 = new Point(this.var_97.x,this.var_97.y);
         this.var_539 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1508 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1003.text = _loc4_;
         this.var_1216.text = _loc5_;
         this.var_1003.height = this.var_1003.textHeight + 5;
         this.var_1216.y = this.var_1003.y + this.var_1003.height;
         this.var_1216.height = Math.max(130,this.var_1216.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_498:
                  ...
                  if(this.var_539 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_539,this.var_1508,this.var_2205);
                     this.var_539.scrollV = 0;
                  }
                  if(this.var_194 != null)
                  {
                     this.var_194.visible = false;
               ...
               case Offer.const_458:
                  ...
                  if(this.var_194 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_71 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_198)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_71:
                        if(_loc8_ != null && this.var_538 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_361,AvatarAction.const_652);
                                 _loc18_.appendAction(AvatarAction.const_358,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2472)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2472 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1817.x;
            this.var_97.y = this.var_1817.y;
            if(param3 != null)
            {
