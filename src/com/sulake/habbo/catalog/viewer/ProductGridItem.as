package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1133:String = "bg";
      ...
      {
         this._view.getChildByName(const_1133).style = HabboWindowStyle.const_29;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1133).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_94,MouseCursorType.const_821);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_821);
         }
      }
