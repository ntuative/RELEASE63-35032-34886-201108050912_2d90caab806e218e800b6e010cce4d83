package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1658:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1610:XML;
      
      private static var var_1608:XML;
       
      
      private var var_2045:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3110:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2045 == 4294967295)
            {
               this.var_2045 = _loc1_.color;
            }
            _loc1_.color = const_1658;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1964;
            }
         }
      }
      ...
      {
         this.var_65 = navigator.catalog.windowManager.buildFromXML(var_1608) as IItemListWindow;
         if(this.var_65 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1610) as IWindowContainer;
         }
         else
         {
