package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_718:uint = 1;
      ...
      private var var_1299:IRoomSession;
      ...
      private var var_264:ICatalogNavigator;
      ...
      private var var_2959:Boolean = true;
      
      private var var_2138:Boolean = false;
      
      private var var_2961:GiftWrappingConfiguration;
      
      private var var_1378:ClubGiftController;
      
      private var var_598:ClubBuyController;
      
      private var var_906:ClubExtendController;
      
      private var var_909:Map;
      
      private var var_1377:Boolean = false;
      
      private var var_908:IPurchasableOffer;
      ...
      private var var_729:RoomPreviewer;
      
      private const const_2105:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_75,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1950);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_413.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2962 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_413.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_182,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      private function initializeRoomPreviewer() : void
      {
         if(this._roomEngine != null && this._configuration != null && this._configuration.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_729 == null)
            {
               this.var_729 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_857 || !this.var_264 || !this.var_264.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1111 = -1;
            this.var_907 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_264.method_6(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_413.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_413.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_63)
         {
            _loc3_ = this.var_413.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_909.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_264 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_718) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2105;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_256,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_75:
               this.var_2138 = param1.session.isPrivateRoom;
               this.var_1299 = param1.session;
               if(this.var_106 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1378 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_906 == null)
         {
            this.var_906 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1660 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_264.buildCatalogIndex(_loc2_);
         if(this.var_907 && this.var_907 != "")
         {
            this.var_264.openPage(this.var_907);
            this.var_907 = "";
            this.var_1111 = -1;
         }
         else if(this.var_1111 > -1)
         {
            this.var_264.method_6(this.var_1111,this.var_2137);
            this.var_1111 = -1;
            this.var_2137 = -1;
            this.var_907 = "";
         }
         else if(this.var_1660 && this.var_2962)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_264.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1995));
         }
         else
         {
            this.var_264.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2960 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1409);
         }
         this.var_2960 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_141,this.var_115.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2959 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1286);
         }
         this.var_2959 = false;
         if(this.var_233 != null && !this.var_233.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_348,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_945)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_348,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_115.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1360 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1378.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2961 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_909.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_909.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1299 || !this.var_1299.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_213);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1377 && param1.type == RoomEngineObjectEvent.const_182)
         {
            this.resetPlacedOfferData(true);
            if(this.var_908 == null || this.var_908.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_908.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_908);
            ...
            if(this.var_66.roomCategory == this._roomEngine.activeRoomCategory && this.var_66.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_367:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_213);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_718);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_729 != null)
         {
            this.var_729.updatePreviewRoomView();
         }
      }
   }
}
