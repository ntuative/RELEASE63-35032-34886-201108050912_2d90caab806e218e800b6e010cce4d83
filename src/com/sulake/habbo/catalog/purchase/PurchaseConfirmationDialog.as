package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2107:uint = 4.294967295E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1274 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_9);
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_384,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_357,this.onMessageInputFocus);
         }
         this.var_1919 = true;
         this.var_1918 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_346,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_635,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1920 = _loc1_.stuffTypes;
            this.var_851 = _loc1_.boxTypes;
            this.var_850 = _loc1_.ribbonTypes;
            this.var_1273 = this.var_1920[0];
            this.var_389 = this.var_851[0];
            this.var_388 = this.var_850[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_388 < 0)
         {
            this.var_388 = this.var_850.length - 1;
         }
         if(this.var_388 > this.var_850.length - 1)
         {
            this.var_388 = 0;
         }
         if(this.var_389 < 0)
         {
            this.var_389 = this.var_851.length - 1;
         }
         if(this.var_389 > this.var_851.length - 1)
         {
            this.var_389 = 0;
         }
         var _loc1_:int = this.var_851[this.var_389] * 1000 + this.var_850[this.var_388];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1273,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1556 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1920)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1273);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_851[this.var_389]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_850[this.var_388]);
         this._catalog.purchaseProductAsGift(this.var_1555,this.var_1274,this.var_1557,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1555,this.var_1274,this.var_1557);
         this.dispose();
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_387 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_387 + 1);
               break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_387) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_852 == null)
         {
            this.var_852 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_289 == null || this.var_852 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_852.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_387) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_387);
         }
         this.var_387 = param1;
         if(this.var_387 < 0)
         {
            this.var_387 = _loc2_.numListItems - 1;
         }
         if(this.var_387 >= _loc2_.numListItems)
         {
            this.var_387 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_387) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1634;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2106) : uint(this.const_2107);
      }
      ...
      {
         this.var_1273 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1273;
               }
            }
            _loc4_++;
         }
