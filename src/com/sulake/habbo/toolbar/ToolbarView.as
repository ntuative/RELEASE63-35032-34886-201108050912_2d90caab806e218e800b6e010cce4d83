package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1576:Point = new Point(3,3);
      
      private static const const_1569:uint = 7433577;
      
      private static const const_1574:uint = 5723213;
      ...
      private static const const_1575:int = 600;
      
      private static const const_1571:int = 80;
      
      private static const const_1573:int = 74;
      ...
      private static const const_1577:int = 10;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1576;
         this._window.addEventListener(WindowEvent.const_590,this.onParentResized);
         ...
         this.var_223.x = _loc13_.width - this.var_223.width - const_480;
         this.var_223.y = const_480;
         this.var_2600 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1575;
         if(!param1 && _loc2_ == this.var_1550)
         {
            return;
         }
         this.var_1550 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1573) : int(const_1571);
         var _loc4_:int = !!_loc2_ ? int(const_1570) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1572 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1577;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_223 != null && this.var_2600)
               {
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_479 ? this.var_1549 : this.var_1548;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_479)
         {
            param1.color = const_1569;
         }
         else
         {
            param1.color = const_1574;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1550 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1550 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1548)
         {
            this.var_1548.dispose();
         }
         this.var_1548 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1549)
         {
            this.var_1549.dispose();
         }
         this.var_1549 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1030.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_480;
            this.var_1030.add(param1,_loc2_);
         }
         return _loc2_;
      }
