package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1635:uint = 16777215;
      
      private static const const_1634:uint = 12247545;
      
      private static const const_1636:String = "HELP";
      ...
      {
         this.var_65.removeListItem(this.var_419);
      }
      
      public function showRoomInfo() : void
      {
         this.var_65.addListItemAt(this.var_419,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_343)
         {
            this.var_343 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_343.x = _loc1_.x + this._window.width - this.var_343.width;
            this.var_343.y = _loc1_.y + this._window.height - this.var_343.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1636);
               break;
