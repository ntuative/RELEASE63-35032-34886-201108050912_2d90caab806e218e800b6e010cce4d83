package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_449:Conversations;
      ...
      {
         if(this._windowManager && this._communication && this._configuration && this._localization && this._friendList && this.var_955 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_449 = new Conversations(new ConversationsDeps(this));
      ...
      {
         var _loc2_:Conversation = this.var_449.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_449.setSelected(_loc2_);
      ...
      {
         return !!this.var_449 ? this.var_449.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_449.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_449.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_753,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1397,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_449.addMessageAndUpdateView(param1);
         if(!this.var_193.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1340);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_449.addMessageAndUpdateView(_loc3_);
      }
