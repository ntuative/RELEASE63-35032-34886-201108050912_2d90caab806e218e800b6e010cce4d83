package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_3077:int;
      
      protected var var_3075:int;
      
      protected var var_1724:Array;
      ...
      {
         this.var_3076 = param1.readString();
         this.var_3077 = param1.readInteger();
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1724.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
