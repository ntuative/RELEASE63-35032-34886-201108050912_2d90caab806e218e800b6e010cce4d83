package com.sulake.habbo.communication.messages.parser.friendlist
{
   ...
   public class EventStreamMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc2_-- > 0)
         {
            this._events.push(new EventStreamData(param1.readInteger(),param1.readInteger(),param1.readString(),param1.readString(),param1.readString(),param1.readString(),param1.readInteger(),param1.readInteger(),param1));
         }
         return true;
      }
   }
