package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_868:IAssetLibrary;
      
      private var var_1313:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_868.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_868.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_597));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_868.loadAssetFromFile("hotel_view_banner_" + this.var_1313,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
