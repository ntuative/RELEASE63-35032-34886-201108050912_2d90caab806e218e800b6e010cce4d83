package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_845:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_131.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_164,HabboWindowStyle.const_46,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2093,"/");
         if(_loc5_ != null)
         {
         ...
         if(this.var_131.habboConfiguration && this.var_131.habboConfiguration.getKey("try.existing.session","false") == "true")
         {
            ...
            this.windowEventProcessor(WindowEvent.allocate(WindowEvent.const_169,this._window,null,false));
         }
      }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2093,"/");
         ...
         {
            dispatchEvent(new Event(const_845));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_154.removeEventListener(SSOTicket.const_411,this.onParsedTicketSuccess);
            this.var_154.removeEventListener(SSOTicket.const_369,this.onParsedTicketFailure);
            this.var_154 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_154 = new SSOTicket(this.var_131.assets,_loc3_,_loc2_,param1);
         this.var_154.addEventListener(SSOTicket.const_411,this.onParsedTicketSuccess);
         this.var_154.addEventListener(SSOTicket.const_369,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_131.flashClientUrl = this.var_154.flashClientUrl;
         this.var_131.ssoTicket = this.var_154.ticket;
         this.var_154.removeEventListener(SSOTicket.const_411,this.onParsedTicketSuccess);
         this.var_154.removeEventListener(SSOTicket.const_369,this.onParsedTicketFailure);
         this.var_154 = null;
         dispatchEvent(new Event(const_845));
