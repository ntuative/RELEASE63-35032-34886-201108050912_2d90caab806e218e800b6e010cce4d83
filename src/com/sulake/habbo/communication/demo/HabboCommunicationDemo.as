package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2338:PseudoRandom;
      ...
      private const const_2093:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_630 = param1;
            this.var_62.initConnection(HabboConnectionType.const_261);
         }
      }
      ...
      {
         if(this.var_62 && this.var_150 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_630 = this.var_150.getKey("sso.ticket",null);
         this.var_1757 = this.var_150.getKey("flash.client.url","");
         this.var_2339 = this.var_150.getKey("external.variables.txt","");
         if(this.var_243 == null)
         {
            this.var_243 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_845,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_2019);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_62.mode = HabboConnectionType.const_1268;
            }
         }
         this.var_62.initConnection(HabboConnectionType.const_261);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2338 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_62.mode)
         {
            case HabboConnectionType.const_95:
               ...
               this.var_243.loadBannerImage(_loc7_ + "?token=" + this.var_1463,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1268:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1949:
               this.var_974 = this.generateRandomHexString(30);
               this.var_530 = new DiffieHellman(new BigInteger(this.var_150.getKey("connection.development.prime"),16),new BigInteger(this.var_150.getKey("connection.development.generator"),16));
               this.var_530.init(this.var_974);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2338);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1462 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_299);
         connection.send(new VersionCheckMessageComposer(401,this.var_1757,this.var_2339));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2093,"/");
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_303);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2337)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1463);
