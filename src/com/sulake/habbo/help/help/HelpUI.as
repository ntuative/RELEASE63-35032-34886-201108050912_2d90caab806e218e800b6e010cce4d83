package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1886:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201108050906));
         this.var_130 = new Map();
         this.var_130.add(HabboHelpViewEnum.const_1881,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_212,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_611,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_329,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_283,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_433,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_843,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_279,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_130.add(HabboHelpViewEnum.const_1178,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_130.add(HabboHelpViewEnum.const_1366,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_130.add(HabboHelpViewEnum.const_811,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_1886)
         {
            this.var_555 = new Array();
         }
         else if(param2)
         {
            if(this.var_555.length == 0 || param1 != this.var_383)
            {
               this.var_555.push(this.var_383);
            }
         }
         this.var_383 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_279:
               this.showUI(HabboHelpViewEnum.const_279);
               break;
            case CallForHelpResultEnum.const_1270:
               this.showUI(HabboHelpViewEnum.const_1366);
               break;
            case CallForHelpResultEnum.const_1304:
               this.showUI(HabboHelpViewEnum.const_1178);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_130.getValue(HabboHelpViewEnum.const_212) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_539));
      }
      ...
      {
         return this.var_130.getValue(this.var_383);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2572 = this._window.width - _loc3_.width;
         this.var_2573 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2573;
         this._window.width = _loc1_.width + this.var_2572;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_555.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_383 == HabboHelpViewEnum.const_212)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_383 == HabboHelpViewEnum.const_212 || this.var_555.length == 0)
         {
            return;
         }
         if(this.var_382 == null)
