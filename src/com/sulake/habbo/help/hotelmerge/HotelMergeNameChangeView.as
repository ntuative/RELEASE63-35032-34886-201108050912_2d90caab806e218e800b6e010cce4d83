package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_786)
         {
            this.var_786 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_786)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_785)
         {
            this.var_785 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_785)
            {
               return;
            }
