package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1628:int = 2;
      ...
      private var var_2075:TriggerConfs;
      
      private var var_2076:ActionTypes;
      
      private var var_2074:ConditionTypes;
      
      private var var_300:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_889:RoomObjectHightLighter;
      ...
      {
         this.var_2075 = new TriggerConfs();
         this.var_2076 = new ActionTypes();
         this.var_2074 = new ConditionTypes();
         this.var_300 = new Dictionary();
         super();
         this.var_93 = param1;
         this.var_889 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_300[param1])
         {
            delete this.var_300[param1];
            this.var_889.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_300[param1] = param2;
            this.var_889.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1350 = new SliderWindowController(this.var_93,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_93.assets,0,20,1);
         this.var_1350.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1350.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_889.hideAll(this.var_300);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1350.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1628) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1628 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2075);
         this.refreshConfigureElement(this.var_2076);
         this.refreshConfigureElement(this.var_2074);
