package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2373:String = "my_issues";
      
      private const const_2375:String = "open_issues";
      
      private const const_2374:String = "picked_issues";
      ...
      private var var_374:IIssueBrowserView;
      
      private var var_1837:IIssueBrowserView;
      
      private var var_1835:IIssueBrowserView;
      
      private var var_1836:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_374.view.width = this.var_280.container.width;
         this.var_374.view.height = this.var_280.container.height;
         this.var_374.visible = true;
         this.var_374.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2373:
               ...
               {
                  this.var_1837 = new MyIssuesView(this.issueManager,this,this.var_280.container);
               }
               return this.var_1837;
            case this.const_2375:
               if(this.var_1835 == null)
               {
                  this.var_1835 = new OpenIssuesView(this.issueManager,this,this.var_280.container);
               }
               return this.var_1835;
            case this.const_2374:
               if(this.var_1836 == null)
               {
                  this.var_1836 = new PickedIssuesView(this.issueManager,this,this.var_280.container);
               }
