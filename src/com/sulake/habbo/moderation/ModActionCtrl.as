package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1375:IDropMenuWindow;
      ...
      private var var_1109:OffenceCategoryData;
      
      private var var_1110:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1376 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1374 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_2061;
         ...
         this.var_1375 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1375);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1109 != null;
         if(this.var_1110 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1110.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1109 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1109.offences,this.var_1376,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1374,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1898;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1659,this.var_597.text,this.var_1658));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1109 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1110 = this.var_1109.offences[_loc3_];
         this.var_597.text = this.var_1110.msg;
         this.var_633 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1659,this.var_597.text,this.var_1658));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1375.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1659,this.var_597.text,this.getBanLength(),this.var_1658));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1375.selection;
