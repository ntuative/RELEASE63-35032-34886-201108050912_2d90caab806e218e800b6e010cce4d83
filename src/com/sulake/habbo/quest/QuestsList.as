package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1705:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_910 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_910.toggle();
         this.var_2144 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1667.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1667[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_622 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_65.spacing = const_1706;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1708;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1705;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2144 && !this.var_2145)
            {
               this.var_2144 = false;
