package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1105:Point = new Point(8,8);
      
      private static const const_1621:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_126 == null || this.var_126.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1105.x;
            _loc8_.y = const_1105.y;
         ...
         var _loc2_:* = this.var_126.waitPeriodSeconds > 0;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1470;
         }
         ...
         this._window.height = _loc8_.height + const_1445;
      ...
      {
         return this.var_126.waitPeriodSeconds < 1 && const_1621.indexOf(this.var_126.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_50.localization.hasKey(this.var_126.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_50.localization.hasKey(this.var_126.getCampaignLocalizationKey() + ".searchtag");
         return this.var_126.waitPeriodSeconds < 1 && (_loc1_ || _loc2_);
      }
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_50.openNavigator(this.var_126);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1582 = NextQuestTimer.const_890;
         var _loc2_:Boolean = this.var_50.questController.questsList.refreshDelay(this._window,this.var_126);
         if(_loc2_)
         {
            this.openDetails(this.var_126);
         }
      }
   }
}
