package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_890:int = 1000;
      
      private static const const_698:String = "next_quest";
      ...
      {
         var _loc1_:int = this.var_126.waitPeriodSeconds;
         if(_loc1_ < 1)
         {
            this.close();
            this.var_126.waitPeriodSeconds = 0;
            this.var_50.questController.onQuest(this.var_126);
         }
         var _loc2_:String = FriendlyTime.getFriendlyTime(this.var_50.localization,_loc1_);
         var _loc3_:* = this.var_126.getCampaignLocalizationKey() + ".delayedmsg";
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_50.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_570 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_570;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_570;
         this._window.findChildByName("more_info_txt").visible = this.var_570 && this.var_50.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_570 && this.var_50.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_570;
         this._window.findChildByName("desc_txt").visible = this.var_570;
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_50.questController.questDetails.showDetails(this.var_126);
         }
      }
