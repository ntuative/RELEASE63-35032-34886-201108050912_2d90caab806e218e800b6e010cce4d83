package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1518:int = 5;
      
      private static const const_1520:int = 800;
      
      private static const const_1519:int = 15;
      
      private static const const_1517:int = 300;
      ...
      private var var_1206:QuestController;
      
      private var var_642:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1206 = new QuestController(this);
         this.var_642 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1518);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_413.events.removeEventListener(BadgeImageReadyEvent.const_152,this.var_642.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_413.events.addEventListener(BadgeImageReadyEvent.const_152,this.var_642.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1206.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_642.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1206.questTracker.isVisible();
      }
      ...
      {
         this.var_1206.update(param1);
         this.var_642.update(param1);
      }
