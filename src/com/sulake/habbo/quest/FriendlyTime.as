package com.sulake.habbo.quest
{
   ...
   public class FriendlyTime
   {
      ...
      private static const const_1087:int = 60;
      
      private static const const_1086:int = 3600;
      
      private static const const_1593:int = 3 * const_1087;
      
      private static const const_1594:int = 3 * const_1086;
      ...
      {
         if(param2 > const_1594)
         {
            return getLocalization(param1,"friendlytime.hours",Math.round(param2 / const_1086));
         }
         if(param2 > const_1593)
         {
            return getLocalization(param1,"friendlytime.minutes",Math.round(param2 / const_1087));
         }
