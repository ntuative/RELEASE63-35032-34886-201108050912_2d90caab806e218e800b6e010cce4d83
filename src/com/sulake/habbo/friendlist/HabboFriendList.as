package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_955:IAvatarRenderManager;
      
      private var var_801:ISessionDataManager;
      
      private var var_2421:FriendListLookAndFeel;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1099)
         {
            this.var_1099.release(new IIDHabboNotifications());
            this.var_1099 = null;
         }
         if(this._toolbar)
         {
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_418);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_385,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_955.createAvatarImage(param1,AvatarScaleType.const_109,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_1099 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1332,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_409,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_469 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_636)
         {
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_409);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_469.findTab(FriendListTab.const_92).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_469.findTab(FriendListTab.const_92);
      ...
      {
         var _loc2_:FriendListTab = this.var_469.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_469.findTab(FriendListTab.const_92);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_801 || !this.var_123)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_801.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_35))
         {
            _loc2_ = this.var_123.vipLimit;
         }
         else if(this.var_801.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_33))
         {
