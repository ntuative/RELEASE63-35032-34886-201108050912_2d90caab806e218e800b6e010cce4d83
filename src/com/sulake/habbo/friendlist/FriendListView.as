package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1576:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2011:FriendListTabsView;
      
      private var var_16:IFrameWindow;
      
      private var var_1061:IWindowContainer;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2011 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1576;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1061 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_307 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_2011.prepare(this.var_1061);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1309,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1401,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_953,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_852,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_953,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_852,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1593 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1593.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2012 == -1 ? 0 : int(this.var_16.height - this.var_2012);
         var _loc4_:int = this.var_2014 == -1 ? 0 : int(this.var_16.width - this.var_2014);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1371,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_953,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1309,false);
         ...
         this.var_2012 = this.var_16.height;
         this.var_2014 = this.var_16.width;
