package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2132:String = "no_reqs_info";
      ...
      private var var_2212:IContainerButtonWindow;
      ...
      {
         this.var_2212 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2211 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2211.procedure = this.onDismissAllButtonClick;
         this.var_2212.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1294)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_421 && _loc2_.state != FriendRequest.const_453)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2212,_loc1_);
         this.setEnabled(this.var_2211,_loc1_);
      }
