package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1552:String = "sendAccessTokenToServer";
      
      private static const const_1551:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1552,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1551,this.jsFaceBookLogOutCallback);
