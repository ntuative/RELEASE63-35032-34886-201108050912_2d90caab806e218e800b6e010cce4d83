package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_535:RoomPopupCtrl;
      
      private var var_622:IScrollbarWindow;
      
      private var var_1194:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_535 = new RoomPopupCtrl(this._navigator,5,-5);
         this.var_1194 = new UserCountRenderer(this._navigator);
      }
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_622 = IScrollbarWindow(this.var_199.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_622.scrollV = 0;
         }
         this.var_199.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_2047,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_231,null,0);
         ...
         this.var_1194.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_535.visible && this.var_2419)
         {
            return;
         }
         ...
         this.var_535.room = _loc4_;
         this.var_535.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1480.tags[0];
            this.var_1480.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2420 - _loc2_.stageX);
         this.var_2420 = _loc2_.stageX;
         this.var_2419 = _loc3_ > 2;
      }
   }
}
