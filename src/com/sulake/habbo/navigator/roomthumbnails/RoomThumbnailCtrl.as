package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2126:IButtonWindow;
      
      private var var_2124:IButtonWindow;
      
      private var var_2125:IButtonWindow;
      
      private var var_2946:IWindowContainer;
      
      private var var_2945:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2126 = IButtonWindow(this.find("bg_tab"));
         this.var_2124 = IButtonWindow(this.find("top_tab"));
         this.var_2125 = IButtonWindow(this.find("obj_tab"));
         this.var_2946 = IWindowContainer(this.find("tile_grid"));
         this.var_2945 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2126,this.onBgTabButton);
         Util.setProcDirectly(this.var_2124,this.onTopTabButton);
         Util.setProcDirectly(this.var_2125,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_2126,this.var_78.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_2124,this.var_78.mode != ThumbnailEditorModel.const_64);
         this.setEnabled(this.var_2125,this.var_78.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2945;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2946;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_600)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_72,HabboWindowStyle.const_29,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
            ...
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_385,HabboWindowStyle.const_46,HabboWindowParam.const_65,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
