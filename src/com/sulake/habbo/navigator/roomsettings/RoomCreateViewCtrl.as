package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1318:TextFieldManager;
      
      private var var_47:Array;
      
      private var var_1319:RoomLayout;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1319.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2026 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2026 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_199 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_65 = IItemListWindow(this.var_199.findChildByName("item_list"));
         ...
         this.var_1318 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_199.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_199.desktop,this.var_199.width,this.var_199.height);
         this.var_199.x = _loc4_.x;
         this.var_199.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1318.goBackToInitialState();
         this.var_1318.input.textBackgroundColor = 4294967295;
         this.var_1319 = this.var_47[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_72,HabboWindowStyle.const_29,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1318.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_199.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_199.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1318.getText();
         var _loc3_:String = "model_" + this.var_1319.name;
