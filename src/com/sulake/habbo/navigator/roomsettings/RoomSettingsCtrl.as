package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1012:IDropMenuWindow;
      
      private var var_2523:IWindowContainer;
      ...
      {
         this.var_376 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_376));
      ...
      {
         if(param1 != this.var_376 || this.var_1230 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1230 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1845)
         {
            this.var_824.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1799)
         {
            this.var_824.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1848)
         {
            this.var_1231.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_2022)
         {
            this.setTagError(this.var_1009,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1013,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1832)
         {
            this.setTagError(this.var_1009,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1013,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_2016)
         {
            this.var_1011.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_824.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_346,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_579,this.onDoorModePasswordUnselect);
         ...
         this.var_824 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1231 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1009 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1013 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1011 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1232 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1233 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1229 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1228 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_826 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1853 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1010 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1012 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2523 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1234 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1236 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1855 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1520 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_1519 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1519.mouseThreshold = 0;
         this.var_1519.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1235.visible = false;
         if(!this.var_1518)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1855.visible = this.var_1518;
         this.populateForm();
         if(this.var_825)
         {
            ...
            this.var_1236.height = Util.getLowestPoint(this.var_1236) + 4;
         }
         else
         {
            this.var_1234.visible = true;
            this.var_1520.visible = true;
            this.var_2523.visible = this.var_1518;
            this.var_1234.height = Util.getLowestPoint(this.var_1234) + 4;
         }
         this.var_1519.text = !!this.var_825 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1234.name,this.var_1236.name,this.var_1520.name,this.var_1855.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_824.setText(_loc1_.name);
         this.var_1231.setText(_loc1_.description);
         this.var_1011.setText("");
         this.var_1232.setText("");
         ...
         {
            case RoomSettingsData.const_231:
         ...
         this.setTag(this.var_1009,_loc1_.tags[0]);
         this.setTag(this.var_1013,_loc1_.tags[1]);
         if(this.var_1233)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1228)
         {
            ...
            {
               this.var_1228.select();
            }
            else
            {
               this.var_1228.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_826);
            this.disableWindow(this.var_1010);
            this.disableWindow(this.var_1012);
            this.disableWindow(this.var_1853);
         }
         else
         {
            this.enableWindow(this.var_826);
            this.enableWindow(this.var_1010);
            this.enableWindow(this.var_1012);
            this.enableWindow(this.var_1853);
         }
         if(this.var_826)
         {
            if(_loc1_.hideWalls)
         ...
         if(this.var_1010)
         {
            this.var_1010.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1012)
         {
            this.var_1012.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_824.getText();
         _loc2_.description = this.var_1231.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_231;
               break;
         ...
         {
            _loc8_ = this.var_1011.getText();
            _loc9_ = this.var_1232.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1011.clearErrors();
         ...
         _loc2_.allowFoodConsume = this.var_1229.isSelected;
         _loc2_.allowWalkThrough = this.var_1228.isSelected;
         _loc2_.hideWalls = this.var_826.isSelected;
         _loc2_.wallThickness = this.var_1010.selection - 2;
         _loc2_.floorThickness = this.var_1012.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1009,_loc2_.tags);
         this.addTag(this.var_1013,_loc2_.tags);
         this.clearErrors();
         this.var_1230 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_376);
         if(this.var_56 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_56.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_376]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_72,HabboWindowStyle.const_29,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_376));
      }
