package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1271:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1271 = new RoomCreateViewCtrl(this);
         this.var_2610 = new RoomThumbnailRenderer(this);
         this.var_1011 = new GuestRoomPasswordInput(this);
         this.var_328 = new GuestRoomDoorbell(this);
         this.var_469 = new Tabs(this);
         this.var_1270 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_385,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_333.startSearch(Tabs.const_316,Tabs.const_671,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_333.startSearch(Tabs.const_270,Tabs.const_311);
         this.var_469.getTab(Tabs.const_270).tabPageDecorator.tabSelected();
      }
