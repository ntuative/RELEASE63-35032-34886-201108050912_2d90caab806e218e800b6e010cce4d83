package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_138:GuestRoomData;
      
      private var var_2610:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2610 = new RoomThumbnailRenderer(param1);
         this.var_1122 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_202,this.var_138);
         if(this.var_138.ownerName != "" && this.var_138.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_202,!!this.var_138.event ? this.getEventCtg(this.var_138.categoryId) : this.getRoomCtg(this.var_138.categoryId));
         this.refreshRoomDesc(this.var_202,this.var_138);
         this.refreshExtraCont();
         this.refreshInfo(this.var_202,"trading_allowed",this.var_138.allowTrading);
         this.refreshInfo(this.var_202,"doormode_doorbell",this.var_138.doorMode == 1);
         this.refreshInfo(this.var_202,"doormode_password",this.var_138.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_202,this.var_138.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1122.refreshTags(_loc1_,this.var_138.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_138.score);
         if(this.var_138.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_138.eventCreationTime);
         }
         this.var_2610.refreshThumbnail(_loc1_,this.var_138.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_316,Tabs.const_444,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
