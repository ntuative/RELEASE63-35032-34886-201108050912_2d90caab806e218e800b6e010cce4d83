package com.sulake.habbo.notifications
{
   ...
   public class ClubGiftNotification
   {
      ...
      private static const const_698:String = "club_gift_notification";
      ...
      public function ClubGiftNotification(param1:int, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboCatalog, param5:IHabboToolbar)
      {
         ...
         this._toolbar.extensionView.attachExtension(const_698,this._window);
         this.var_2151 = this._window.findChildByName("cancel_link") as ITextWindow;
      ...
      public function dispose() : void
      {
         if(this._toolbar)
         {
            this._toolbar.extensionView.detachExtension(const_698);
         }
         if(this._window != null)
         {
      ...
      {
         this.var_2151.textColor = const_1590;
      }
      
      private function onMouseOut(param1:WindowMouseEvent) : void
      {
         this.var_2151.textColor = const_1592;
      }
