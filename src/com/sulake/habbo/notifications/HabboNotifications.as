package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1677:String = "pixelbalance";
      
      private static const const_1680:String = "badges";
      
      private static const const_1676:String = "selectbadge";
      
      private static const const_1682:String = "inventory";
      
      private static const const_1681:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1678:String = "friendlist";
      
      private static const const_1679:String = "pet_inventory";
      
      private static const const_1683:String = "go_to_room";
      ...
      private var var_2098:IHabboToolbar;
      ...
      private var var_589:HabboNotificationViewManager;
      
      private var var_259:HabboAlertDialogManager;
      
      private var var_896:ParkBusDialogManager;
      
      private var var_2883:Boolean;
      
      private var var_1092:ClubGiftNotification;
      
      private var var_1093:ClubEndingNotification;
      
      private var var_1090:ClubPromoNotification;
      
      private var var_3118:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1894 = false;
         this.var_3118 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1091);
         }
         var _loc6_:Map = this.var_1091["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1091["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_2098 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_589 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_2098,this.var_1091["styles"],this.var_1091["view"]);
         ...
         registerUpdateReceiver(this.var_589,1);
         registerUpdateReceiver(this,2);
         this.var_413.events.addEventListener(BadgeImageReadyEvent.const_152,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_413.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1245,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1245,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_2062,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_841,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_413.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_413.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_413.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_2010,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1302)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1853,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1090 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1093 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_589.isSpaceAvailable() && this.var_1362.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_589.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1680:
               if(this.var_12 != null)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_250);
               }
               break;
            case const_1676:
               break;
            ...
            case const_1679:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_132);
               }
               break;
            case const_1681:
               break;
      ...
      {
         if(param1 != null && this.var_589 != null)
         {
            this.var_589.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_896 == null)
         {
            this.var_896 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_896 != null)
         {
            this.var_896.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1236,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1236,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1016.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2883)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_841,null);
            this.var_2883 = true;
      ...
      {
         if(param2.type == WindowEvent.const_169 || param2.type == WindowEvent.const_656)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1092 && this.var_1092.visible)
         {
            return;
         }
         this.var_1092 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_2098);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_841,_loc6_);
      }
   }
}
