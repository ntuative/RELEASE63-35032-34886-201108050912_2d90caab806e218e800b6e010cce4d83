package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_818 = [];
         this.var_818.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_818.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_818.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         if(param1 < 0 || param1 >= this.var_540.length)
         {
            return null;
         }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_716 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_240.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_126,_loc3_.syncCount / 1000,0,1,1);
         ...
         this.var_1824 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_102,HabboMusicPrioritiesEnum.const_126,_loc3_.currentSongId,_loc3_.currentPosition));
      }
