package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_818.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_818.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_818)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_990,this.onJukeboxInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_275,this.onJukeboxDispose);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_748,this.onSoundMachineInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_936,this.onSoundMachineDispose);
         ...
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_315)
         {
            this.var_327[_loc6_] = null;
            this.var_806[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1793)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_412)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_130,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_990,this.onJukeboxInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_275,this.onJukeboxDispose);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_748,this.onSoundMachineInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_936,this.onSoundMachineDispose);
            }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_315)
         {
      ...
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         ...
         {
            return this.var_373.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_373.length)
         {
            return this.var_373.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_275.length)
         {
            ...
            if(_loc3_.id != this.var_1482 && _loc4_ != null && _loc4_.ready)
            {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_805.indexOf(_loc6_.id) != -1)
               {
                  this.var_805.splice(this.var_805.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_315)
         {
            return false;
         }
         ...
         this.var_1793 = this.getSongRequestCountAtPriority(param1);
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2426 != param1.id || _loc3_ > this.var_2425 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2426 = param1.id;
            this.var_2425 = _loc3_;
         }
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_373.add(_loc5_,_loc6_);
            if(this.var_275.getValue(_loc6_) == null)
            {
               this.var_805.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_536 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_93,this._connection) as IPlayListController;
      }
