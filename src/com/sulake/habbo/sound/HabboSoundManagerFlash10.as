package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1690:int = 60;
      
      private static const const_1689:int = 25165823;
      
      private static const const_1691:int = 16777215;
      ...
      private var var_998:Number = 1.0;
      ...
      private var var_1645:ByteArray;
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1100.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1422:
                  ...
                  break;
               case HabboSoundTypesEnum.const_2053:
               ...
               case HabboSoundTypesEnum.const_1409:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1974:
            ...
            this.var_1100.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_998;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_722.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1366.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1099.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1099 = IHabboNotifications(param2);
      }
      ...
      {
         if(this._configuration == null || this._connection == null || this._roomEngine == null || this.var_240 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1844,this.var_899));
         this.var_899 = -1;
         this.var_900 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_998 * 100)));
         }
      }
      ...
      {
         this.var_998 = param1;
         this.var_240.updateVolume(this.var_998);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_722.remove(param1);
            if(this.var_303.getValue(_loc2_) == null)
            {
               this.var_1645.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1645,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1645,_loc2_,TraxSample.const_1800,TraxSample.const_1963);
      ...
      private function processLoadedSamples() : void
      {
         ...
         if(this.var_1365.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1690 && this.var_1365.length > 0)
            {
               _loc3_ = this.var_1365.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_722.length == 0 && this.var_899 != -1)
            {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_900 == null && this.var_1366.length > 0)
         {
            _loc1_ = this.var_1366.getKey(0);
            _loc2_ = this.var_1366.remove(_loc1_);
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1689)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1691 && _loc9_ < _loc2_.length)
            {
