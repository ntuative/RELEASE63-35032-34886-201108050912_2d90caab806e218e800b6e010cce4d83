package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_2027:Boolean = true;
      
      private var var_1601:int = -1.0E9;
      ...
      {
         if(this.var_1059 != 0 || this.var_1058 != 0)
         {
            if(this.var_11 != null)
            {
               this.var_11.disposeRoom(this.var_1059,this.var_1058);
            }
         }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_1059 != _loc3_.roomId || this.var_1058 != _loc3_.roomCategory)
         {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc19_ < _loc7_)
            {
               ...
               if(!_loc13_)
               {
                  if((_loc15_ > 0 && _loc15_ < _loc8_ - 1 || _loc19_ > 0 && _loc19_ < _loc7_ - 1) && _loc20_ != RoomPlaneParser.const_58)
                  {
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_58 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_58 && _loc3_.getTileHeight(_loc19_,_loc15_ + 1) == RoomPlaneParser.const_58)
                     {
                     ...
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_58 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_58 && _loc3_.getTileHeight(_loc19_ + 1,_loc15_) == RoomPlaneParser.const_58)
                     {
               ...
               for each(_loc18_ in _loc9_.actions)
               {
                  switch(_loc18_.actionType)
                  {
                     case "flatctrl":
                        ...
                        break;
                     case "sign":
                        this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc9_.id,RoomObjectVariableEnum.const_451,int(_loc18_.actionParameter));
                        break;
                     case "gst":
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_289,_loc6_);
      }
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_542,_loc3_.danceStyle);
      }
      ...
      private function onAvatarSleep(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_298,_loc6_);
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_308,_loc2_.itemType);
         }
      }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc8_.moveType)
               {
                  case SlideObjectMessageData.const_1179:
                     _loc9_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1392:
                     _loc9_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1291,_loc3_.status);
         }
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_462,_loc2_.value);
         }
      }
   }
}
