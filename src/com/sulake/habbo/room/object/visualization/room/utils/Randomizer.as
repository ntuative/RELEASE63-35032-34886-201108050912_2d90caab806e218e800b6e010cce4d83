package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2347:int = 1;
      
      public static const const_2154:int = 16777216;
      ...
      private var var_1912:int = 16777216;
      
      private var var_3103:int = 69069;
      
      private var var_3104:int = 5;
      ...
      {
         var _loc1_:int = this.var_3103 * this.var_1913 + this.var_3104;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1912;
         this.var_1913 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1912 * param2);
      }
   }
}
