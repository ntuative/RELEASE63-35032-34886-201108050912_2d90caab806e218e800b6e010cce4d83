package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1106:int = 1000;
      
      private static const const_1629:String = "pet_experience_bubble_png";
      
      private static const const_1630:int = 0;
      
      private static const const_1628:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1629) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_396 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_310);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_143);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_310);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_2178 = _loc3_.getNumber(RoomObjectVariableEnum.const_298) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_233);
            if(!isNaN(_loc8_))
            {
               this.var_2001 = _loc8_;
            }
            else
            {
               this.var_2001 = direction;
            }
            this.var_1567 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2382 = _loc3_.getNumber(RoomObjectVariableEnum.const_415);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_948);
            if(_loc9_ != this.var_2002)
            {
               this.var_2002 = _loc9_;
               this.var_2727 = this.var_2002.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_396 != null)
         {
            ...
            if(this.var_1567 > 0)
            {
               _loc2_ = param1 - this.var_1567;
               if(_loc2_ < const_1106)
               {
                  this.var_396.alpha = int(Math.sin(_loc2_ / const_1106 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_396.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_396.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_313)
         {
            ...
            this.setAnimationForIndex(const_1630,_loc3_);
         }
         if(param2 != this.var_1566)
         {
            this.var_1566 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_101,param2);
            this.setAnimationForIndex(const_1628,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2727);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_705)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_516.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_516[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2001);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_101,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1627)
            {
               this.var_1053[param1] = true;
            }
            else
            {
               this.var_1053[param1] = false;
            }
         }
         return this.var_1053[param1];
      }
   }
}
