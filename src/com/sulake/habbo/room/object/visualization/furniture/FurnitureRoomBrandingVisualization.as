package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1564:String = "branded_image";
      
      private static const const_1562:int = 0;
      
      private static const const_1565:int = 1;
      
      private static const const_1561:int = 2;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1727 = _loc4_.getNumber(RoomObjectVariableEnum.const_653);
                  this.var_1728 = _loc4_.getNumber(RoomObjectVariableEnum.const_664);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_675);
               }
            }
         }
         if(!this.var_1432)
         {
            this.var_1432 = this.checkIfImageReady();
            if(this.var_1432)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1564)
         {
