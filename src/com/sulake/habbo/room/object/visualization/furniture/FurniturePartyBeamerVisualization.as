package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1530:int = 1;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_819[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_819[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_819.length == 2)
            {
               return this.var_819[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_819.length == 2)
            {
               return this.var_819[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1223[param2];
         var _loc4_:int = this.var_1224[param2];
         var _loc5_:int = this.var_1221[param2];
         var _loc6_:Number = this.var_1222[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1073;
         }
         ...
         this.var_1223[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1222[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1223.push(Math.random() * _loc2_ * 1.5);
         this.var_1223.push(Math.random() * _loc2_ * 1.5);
         this.var_1224 = new Array();
         this.var_1224.push(1);
         this.var_1224.push(-1);
         this.var_1221 = new Array();
         this.var_1221.push(const_1529);
         this.var_1221.push(const_1530);
         this.var_1222 = new Array();
         this.var_1222.push(this.getRandomAmplitudeFactor());
         this.var_1222.push(this.getRandomAmplitudeFactor());
      }
