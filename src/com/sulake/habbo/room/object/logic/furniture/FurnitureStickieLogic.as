package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_154,RoomObjectFurnitureActionEvent.const_554];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(object != null)
         {
            object.getModelController().setString(RoomObjectVariableEnum.const_1381,"");
         }
      }
