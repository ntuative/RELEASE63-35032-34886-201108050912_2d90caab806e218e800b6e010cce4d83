package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1058:int = 0;
      
      private static const const_2094:int = 1;
      
      private static const const_1057:int = 10;
       
      
      private var var_1767:Vector3d = null;
      
      public function FurniturePushableLogic()
      {
         super();
         moveUpdateInterval = const_870;
         this.var_1767 = new Vector3d();
      }
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1767.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1767).length == 0)
            {
               if(object.getState(0) != const_1058)
               {
                  object.setState(const_1058,0);
               }
            }
         }
      }
