package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1574:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_645,RoomObjectMouseEvent.const_168];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_755,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_1009,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_955,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1034,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1026,1);
         }
      }
         ...
         if(this.var_1575)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_755,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1334,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1292)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1967;
            if(_loc2_ - this.var_1292 >= this.var_1968)
            {
               _loc3_ = this.var_1291;
               _loc4_ = this.var_1966;
               this.var_1292 = 0;
            }
            else
            {
               _loc7_ = this.var_1574 >> 16 & 255;
               _loc8_ = this.var_1574 >> 8 & 255;
               _loc9_ = this.var_1574 & 255;
               _loc10_ = this.var_1291 >> 16 & 255;
               _loc11_ = this.var_1291 >> 8 & 255;
               _loc12_ = this.var_1291 & 255;
               _loc13_ = (_loc2_ - this.var_1292) / this.var_1968;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1965 + (this.var_1966 - this.var_1965) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_1009,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_861:
            ...
            case RoomObjectRoomUpdateMessage.const_1014:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_752:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_556:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_282)
               {
                  _loc5_ = "null";
               }
               this.var_586.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_902:
               _loc4_ = this.var_586.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_586.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1403,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1256:
               param2.setNumber(RoomObjectVariableEnum.const_955,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1356:
               param2.setNumber(RoomObjectVariableEnum.const_1034,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_1026,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_694:
               param2.setNumber(RoomObjectVariableEnum.const_1337,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1188:
               param2.setNumber(RoomObjectVariableEnum.const_1250,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_181:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1417,int(param1.bgOnly));
         this.var_1574 = this._color;
         this.var_1965 = this.var_1967;
         this.var_1291 = _loc3_;
         this.var_1966 = _loc4_;
         this.var_1292 = getTimer();
         this.var_1968 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1804,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1928,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1838,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_258 || _loc12_ == RoomPlaneData.const_405)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
