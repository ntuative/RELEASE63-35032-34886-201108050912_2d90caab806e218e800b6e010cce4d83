package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1496:String = "goawaybus";
      
      private static const const_1495:String = "bus";
      
      private static const const_1494:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_528,RoomObjectRoomActionEvent.const_563];
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1495:
                  case const_1494:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_563,0,_loc4_,_loc5_);
               }
         }
