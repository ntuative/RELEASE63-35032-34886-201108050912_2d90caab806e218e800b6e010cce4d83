package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_168,RoomObjectMoveEvent.const_420];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_3034)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_233,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1495 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_298,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_2013,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_948,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_233,_loc3_ + this.var_1140);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2193;
            _loc2_.setNumber(RoomObjectVariableEnum.const_310,this.var_2193);
            _loc2_.setNumber(RoomObjectVariableEnum.const_143,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2194;
            _loc2_.setNumber(RoomObjectVariableEnum.const_143,this.var_2194);
         }
         else
         {
            this.var_1140 += 45;
