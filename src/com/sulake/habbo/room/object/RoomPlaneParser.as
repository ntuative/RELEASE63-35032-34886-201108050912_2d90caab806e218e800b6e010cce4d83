package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_694:Number = 0.25;
      
      private static const const_1188:Number = 0.25;
      
      public static const const_58:int = -110;
      
      public static const const_232:int = -100;
      ...
      private var var_1039:Number = 1.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            while(_loc7_ < param1)
            {
               _loc4_[_loc7_] = const_58;
               _loc5_[_loc7_] = const_58;
               _loc6_[_loc7_] = false;
               _loc7_++;
            }
            this.var_132.push(_loc4_);
            this.var_567.push(_loc5_);
            this.var_566.push(_loc6_);
            _loc3_++;
         }
         this.var_225 = param1;
         this._height = param2;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_225 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this._minX || param1 == this.var_474)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_476;
               ...
               if(param2 == this.var_476 || param2 == this.var_475)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
                  while(_loc8_ < this.var_474)
                  {
      ...
      private function getTileHeightOriginal(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_567[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc3_ < this._height)
         {
            ...
            {
               this.var_567[_loc3_][_loc2_] = this.var_132[_loc3_][_loc2_];
               _loc2_++;
            }
            _loc3_++;
         }
         var _loc4_:Point = findEntranceTile(this.var_132);
         _loc3_ = 0;
         while(_loc3_ < this._height)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_225)
            {
               if(this.var_566[_loc3_][_loc2_])
               {
                  this.setTileHeight(_loc2_,_loc3_,const_232);
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         if(param1 != null)
         {
            ...
            this.setTileHeight(param1.x,param1.y,const_58);
         }
         this.var_1116 = getFloorHeight(this.var_132);
         if(!param2)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_132.length)
         {
            _loc4_ = this.var_132[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      private function updateWallsNextToHoles(param1:RoomWallData) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(!param1.getHideWall(_loc3_))
            {
               ...
               _loc8_ = RoomWallData.var_512[_loc5_];
               _loc9_ = 0;
               _loc10_ = 0;
               while(_loc10_ < _loc6_)
               {
                  if(this.getTileHeightInternal(_loc4_.x + _loc10_ * _loc7_.x - _loc8_.x,_loc4_.y + _loc10_ * _loc7_.y - _loc8_.y) == const_232)
                  {
      ...
      private function addWalls(param1:RoomWallData, param2:RoomWallData) : void
      {
         ...
         while(_loc7_ < _loc3_)
         {
            if(!param1.getHideWall(_loc7_))
            {
               ...
               _loc12_ = RoomWallData.var_512[_loc9_];
               _loc13_ = -1;
               _loc14_ = 0;
               ...
               {
                  _loc21_ = RoomWallData.var_512[_loc5_];
               }
               else if((_loc9_ - _loc6_ + 4) % 4 == 3)
               {
                  _loc21_ = RoomWallData.var_512[_loc6_];
               }
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         {
            if(this.getTileHeightInternal(_loc8_,_loc9_) > const_232)
            {
               _loc9_--;
               break;
            }
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_258,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_405,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1188 * this.var_1572;
         var _loc9_:Number = const_694 * this.var_1039;
         ...
         this.addPlane(RoomPlaneData.const_258,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_258,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_258,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_258,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      private function getHeightMapWidth(param1:Array) : int
      {
         ...
         while(_loc6_ < _loc2_)
         {
            ...
            _loc4_ = this.var_132[_loc6_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_268,param1,param2,param3);
         var _loc15_:IVector3d = param1;
         var _loc16_:* = null;
         var _loc17_:* = null;
         if(_loc14_)
         {
            _loc18_ = const_694 * this.var_1039;
            _loc19_ = _loc18_;
            if(this.var_1039 > 1)
            {
               _loc19_ = const_694;
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_268,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_268,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_268,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_268,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_225}" height="{this._height}" wallHeight="{this.var_1571}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc7_ = <tileRow/>;
            _loc8_ = this.var_567[_loc2_];
            _loc9_ = 0;
         ...
         {
            _loc12_ = this.var_337.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_337.getKey(_loc4_);
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_160[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1336;
         }
         var _loc2_:RoomPlaneData = this.var_160[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_160[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_337.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_337.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc4_ < this.var_337.length)
         {
            _loc5_ = this.var_337.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
