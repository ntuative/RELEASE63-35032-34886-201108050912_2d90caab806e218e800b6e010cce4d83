package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2074:String = "friend_requests_tab_xml";
      ...
      protected static const const_680:String = "request_entity_list";
      
      protected static const const_732:String = "name";
      
      protected static const const_2071:String = "badge_counter";
      
      protected static const const_2075:String = "button_accept_all";
      
      protected static const const_2073:String = "click_area_discard_all";
      
      protected static const const_1438:String = "button_close";
      
      protected static const const_2072:String = "button_accept";
      
      protected static const const_1037:String = "click_area_discard";
      
      protected static const const_1432:String = "text_discard";
      
      private static var var_1554:FriendRequestsTab;
      
      private static const const_73:uint = 4294625561;
      
      private static const const_1082:uint = 4294957414;
      
      private static const const_1582:uint = 4289431312;
      
      private static const const_1583:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1581:uint = 16777215;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1554 ? var_1554 : new FriendRequestsTab();
         _loc2_.var_169 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2071).caption = String(param1.length);
         return _loc2_;
      }
         ...
         if(!disposed)
         {
            if(!var_169)
            {
               if(_window)
               {
                  ...
                  if(_loc1_)
                  {
                     _loc2_ = _loc1_.content.getChildByName(const_680) as IItemListWindow;
                     if(_loc2_)
                     {
         ...
         if(!selected)
         {
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1917)
                  {
                     _loc3_ = _loc2_.content.getChildByName(const_680) as IItemListWindow;
                     if(_loc3_)
                     {
                        _loc7_ = 0;
                        _loc8_ = 0;
                        ...
                        {
                           _loc4_ = this.var_1272.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1582) : uint(const_1583);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_732).caption = _loc5_.name;
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         var _loc7_:IItemListWindow = _loc4_.content.getChildByName(const_680) as IItemListWindow;
         this.var_1272 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1038)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1432)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1037)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1432)).textColor = const_1581;
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         if(_loc3_)
         {
            _loc4_ = _loc3_.content.getChildByName(const_680) as IItemListWindow;
            if(_loc4_)
            {
               _loc6_ = 0;
