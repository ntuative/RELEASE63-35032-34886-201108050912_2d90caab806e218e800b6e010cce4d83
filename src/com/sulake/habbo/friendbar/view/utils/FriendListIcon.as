package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_1176:int = 200;
      
      private static const const_1177:int = 500;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1176) : int(const_1177));
         if(!var_616 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_616,!!_hover ? int(const_1176) : int(const_1177));
         if(!var_616 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
