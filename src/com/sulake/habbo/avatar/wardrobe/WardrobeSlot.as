package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_631 && this.var_1465)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_109,this._gender,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_42,parseInt(FigureData.const_1010));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_631 = this.var_27.figureData.getFigureString();
               this._gender = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_1760,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_631)
               {
                  this.var_27.loadAvatarInEditor(this.var_631,this._gender,this.var_27.clubMemberLevel);
               }
         }
      }
