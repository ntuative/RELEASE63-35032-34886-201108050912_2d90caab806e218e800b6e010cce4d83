package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_979:IItemListWindow;
      
      private var var_1189:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_979 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1189 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(this.var_979)
         {
            this.var_979.removeListItems();
         }
         if(this.var_1189)
         {
            this.var_1189.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_979)
               {
                  this.var_979.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(this.var_1189)
            {
               this.var_1189.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
