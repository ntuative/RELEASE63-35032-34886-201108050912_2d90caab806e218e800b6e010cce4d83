package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_721:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_721 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_721.numGridItems > 0)
         {
            this.var_721.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_78 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_78.hotLooks)
         {
            ...
            this.var_721.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_721.getGridItemIndex(param2.parent);
