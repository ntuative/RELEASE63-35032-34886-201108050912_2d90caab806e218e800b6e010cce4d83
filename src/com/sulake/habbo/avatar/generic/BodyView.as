      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_78.controller.gender)
         {
            case FigureData.const_87:
               activateTab(this.const_721);
               inactivateTab(this.const_720);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_720);
               inactivateTab(this.const_721);
         }
      }
