package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1858:Number = 1.0;
      
      private var var_1857:Number = 1.0;
      
      private var var_1859:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1361:Map;
      
      private var var_2874:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2092 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2875 = parseInt(_loc2_,16);
         this.var_2873 = parseInt(_loc3_,16);
         ...
         this.var_901 = new ColorTransform(this.var_1858,this.var_1857,this.var_1859,this._alphaMultiplier);
         this.var_1361 = this.generatePaletteMapForGrayscale(this.var_2873,this.var_2875);
      }
      ...
      {
         return this.var_1361.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1361.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1361.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1361.getValue("alphas") as Array;
      }
