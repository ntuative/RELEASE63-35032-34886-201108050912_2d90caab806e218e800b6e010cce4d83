package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_297:AvatarImageCache;
      
      private var var_700:int = 0;
      
      private var var_2024:int = 0;
      
      private var var_631:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_631 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_631.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1641 = this.var_1321;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_57)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1641);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_700);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_631,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1641 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_700);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_700);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_631,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_109)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_700);
         ...
         switch(param1)
         {
            case AvatarAction.const_438:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1791:
                  case AvatarAction.const_1970:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1096);
         this.getCache().resetBodyPartCache(this.var_1096);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1642 = this._structure.sortActions(this.var_363);
         ...
         {
            this.var_873 = this._structure.getCanvasOffsets(this.var_1642,this._scale,this.var_102);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1642)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1321 = _loc4_.id;
                     this.var_1811 = _loc4_.breed;
                     break;
                  }
               }
            }
