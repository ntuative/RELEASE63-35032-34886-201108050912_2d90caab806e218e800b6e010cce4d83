package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_646 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_646.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_646.scrollV;
         this.var_646.removeGridItems();
         this.var_1006.removeGridItems();
         var _loc2_:Array = this.var_78.getBadges(BadgesModel.const_625);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_646.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_646.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_78.getBadges(BadgesModel.const_381);
         _loc4_ = 0;
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_78.getBadges(BadgesModel.const_381);
      ...
      {
         var _loc2_:int = this.var_646.getGridItemIndex(param1.window);
