package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1500.setSelectedGridItem(this);
               this.var_1501 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1501 = false;
                  this.var_1500.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1499)
         {
            return;
         }
         this.var_1499.color = !!this.var_1473 ? uint(const_1500) : uint(const_1499);
         this.var_2379.visible = param1;
      }
