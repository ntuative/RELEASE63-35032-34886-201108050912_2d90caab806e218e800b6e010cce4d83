package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2386:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_75,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_608,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_64.getValue(InventorySubCategory.const_380));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_64.getValue(InventoryCategory.const_156));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_64.getValue(InventoryCategory.const_250));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_64.getValue(InventorySubCategory.const_1252));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_64.getValue(InventoryCategory.const_132));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_64.getValue(InventoryCategory.const_436) as MarketplaceModel;
      }
      ...
      {
         this.var_413 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_75,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_608,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_85:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_608:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_413 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_64.add(InventoryCategory.const_436,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_413);
         this.var_64.add(InventoryCategory.const_250,_loc3_);
         ...
         this.var_64.add(InventoryCategory.const_156,_loc4_);
         ...
         this.var_64.add(InventorySubCategory.const_380,_loc5_);
         ...
         this.var_64.add(InventorySubCategory.const_1252,_loc6_);
         ...
         this.var_64.add(InventoryCategory.const_132,_loc7_);
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_380:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1048.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1048.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1048.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2386);
         }
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2704)
         {
            this.var_2704 = _loc1_;
