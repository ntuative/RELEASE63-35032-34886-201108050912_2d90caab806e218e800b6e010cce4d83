package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1499:int = 13421772;
      
      private static const const_1500:int = 10275685;
      ...
      protected var var_953:int = 0;
      
      protected var var_763:BitmapData;
      ...
      protected var var_3079:BitmapData;
      
      private var var_1540:Boolean;
      
      private const const_2100:Number = 1;
      
      private const const_2099:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2379 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2278 == FurniModelCategory.const_38)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1914));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_1018)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         this.var_1499.color = !!this.var_1540 ? uint(const_1500) : uint(const_1499);
         this.var_2379.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2279 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3079;
               _loc5_.visible = true;
            }
            else
            {
