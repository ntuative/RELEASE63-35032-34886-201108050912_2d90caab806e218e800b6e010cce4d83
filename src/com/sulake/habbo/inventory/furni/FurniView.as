package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2116:int = 0;
      ...
      private static const const_1129:int = 42;
      
      private static const const_1131:int = 120;
      ...
      private var var_788:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_231.add(FurniModelCategory.const_38,new FurniGridView(this.var_78,FurniModelCategory.const_38,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_231.add(FurniModelCategory.const_43,new FurniGridView(this.var_78,FurniModelCategory.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1076;
            _loc3_.y = _loc4_.y + const_1076;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FurniModelCategory.const_43:
               ...
               this.var_488 = FurniModelCategory.const_43;
               break;
            case FurniModelCategory.const_38:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_488 = FurniModelCategory.const_38;
               break;
            case FurniModelCategory.const_248:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_488 = FurniModelCategory.const_248;
               break;
            default:
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_231.getValue(this.var_488);
         if(_loc3_)
         {
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_38,FurniModelCategory.const_43];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_231.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_231.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_231.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_231.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_213);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_788 && this.var_788.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1359)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1131)
         {
            _loc3_ = const_1131;
         }
         else if(_loc3_ < const_1129)
         {
            _loc3_ = const_1129;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_47)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_248);
            }
         }
      }
