package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_448 = [];
         this.var_447 = [];
         this.var_640 = new Timer(const_1513,1);
         this.var_640.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_182,this.onObjectPlaced);
               }
            ...
            {
               this.var_640.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_640.stop();
               this.var_640 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_810 == null)
         {
            this.var_810 = this._windowManager.buildFromXML(this.var_2443) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_810.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_810.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_38,const_43];
         var _loc5_:int = 0;
      ...
      {
         this.var_2442 = getTimer();
         this.switchCategory(const_248);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_436);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_38,const_43];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_38,const_43];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_639.add(const_38,new Array());
         this.var_639.add(const_43,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_248)
            {
      ...
      {
         return getTimer() < this.var_2442 + const_1514;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_380;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_374 || _loc3_.category == FurniCategory.const_367 || _loc3_.category == FurniCategory.const_378)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_639.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_1018)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
