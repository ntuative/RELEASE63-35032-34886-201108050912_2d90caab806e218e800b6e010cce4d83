package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_251 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_251.id);
            this.var_251 = null;
         }
      }
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2795 = _loc2_;
         this.var_2794 = this.var_251.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_2046,this.var_2047);
         }
      }
      ...
      {
         if(param1 != this.var_2795 || param2 != this.var_2794)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2551);
      }
